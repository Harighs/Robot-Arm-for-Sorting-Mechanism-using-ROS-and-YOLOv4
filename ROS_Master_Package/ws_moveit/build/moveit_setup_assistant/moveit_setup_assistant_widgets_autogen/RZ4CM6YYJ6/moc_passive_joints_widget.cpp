...
#include "../../../../src/moveit/moveit_setup_assistant/src/widgets/passive_joints_widget.h"
...
struct qt_meta_stringdata_moveit_setup_assistant__PassiveJointsWidget_t {
    QByteArrayData data[6];
    char stringdata0[116];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_moveit_setup_assistant__PassiveJointsWidget_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_moveit_setup_assistant__PassiveJointsWidget_t qt_meta_stringdata_moveit_setup_assistant__PassiveJointsWidget = {
    {
QT_MOC_LITERAL(0, 0, 43), // "moveit_setup_assistant::Passi..."
QT_MOC_LITERAL(1, 44, 16), // "selectionUpdated"
QT_MOC_LITERAL(2, 61, 0), // ""
QT_MOC_LITERAL(3, 62, 21), // "previewSelectedJoints"
QT_MOC_LITERAL(4, 84, 24), // "std::vector<std::string>"
QT_MOC_LITERAL(5, 109, 6) // "joints"
...
QT_INIT_METAOBJECT const QMetaObject moveit_setup_assistant::PassiveJointsWidget::staticMetaObject = { {
    &SetupScreenWidget::staticMetaObject,
    qt_meta_stringdata_moveit_setup_assistant__PassiveJointsWidget.data,
    qt_meta_data_moveit_setup_assistant__PassiveJointsWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *moveit_setup_assistant::PassiveJointsWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_moveit_setup_assistant__PassiveJointsWidget.stringdata0))
