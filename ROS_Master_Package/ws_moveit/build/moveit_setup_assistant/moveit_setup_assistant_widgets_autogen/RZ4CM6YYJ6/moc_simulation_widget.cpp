...
QT_INIT_METAOBJECT const QMetaObject moveit_setup_assistant::SimulationWidget::staticMetaObject = { {
    &SetupScreenWidget::staticMetaObject,
    qt_meta_stringdata_moveit_setup_assistant__SimulationWidget.data,
    qt_meta_data_moveit_setup_assistant__SimulationWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
