...
void rviz_visual_tools::RvizVisualToolsGui::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<RvizVisualToolsGui *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject rviz_visual_tools::RvizVisualToolsGui::staticMetaObject = { {
    &rviz::Panel::staticMetaObject,
    qt_meta_stringdata_rviz_visual_tools__RvizVisualToolsGui.data,
    qt_meta_data_rviz_visual_tools__RvizVisualToolsGui,
    qt_static_metacall,
    nullptr,
    nullptr
} };
