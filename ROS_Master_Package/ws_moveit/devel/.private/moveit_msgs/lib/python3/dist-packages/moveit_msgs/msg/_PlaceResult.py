...
class PlaceResult(genpy.Message):
  _md5sum = "978b357573c8ba8c31923f06ac62d8de"
...
Vector3 vector
"""
  __slots__ = ['error_code','trajectory_start','trajectory_stages','trajectory_descriptions','place_location','planning_time']
  _slot_types = ['moveit_msgs/MoveItErrorCodes','moveit_msgs/RobotState','moveit_msgs/RobotTrajectory[]','string[]','moveit_msgs/PlaceLocation','float64']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       error_code,trajectory_start,trajectory_stages,trajectory_descriptions,place_location,planning_time
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.place_location.place_pose.pose.position.x, _x.place_location.place_pose.pose.position.y, _x.place_location.place_pose.pose.position.z, _x.place_location.place_pose.pose.orientation.x, _x.place_location.place_pose.pose.orientation.y, _x.place_location.place_pose.pose.orientation.z, _x.place_location.place_pose.pose.orientation.w, _x.place_location.quality, _x.place_location.pre_place_approach.direction.header.seq, _x.place_location.pre_place_approach.direction.header.stamp.secs, _x.place_location.pre_place_approach.direction.header.stamp.nsecs,) = _get_struct_8d3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
