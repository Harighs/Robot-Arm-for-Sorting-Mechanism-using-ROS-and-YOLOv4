...
"""autogenerated by genpy from moveit_msgs/MotionSequenceItem.msg. Do not edit."""
import codecs
import sys
...
class MotionSequenceItem(genpy.Message):
  _md5sum = "2d640cc6ec9b15fdbde900aedc333486"
  _type = "moveit_msgs/MotionSequenceItem"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# The plan request for this item.
...
"""
  ...
  _slot_types = ['moveit_msgs/MotionPlanRequest','float64']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MotionSequenceItem, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.req is None:
        self.req = moveit_msgs.msg.MotionPlanRequest()
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_3I().pack(_x.req.workspace_parameters.header.seq, _x.req.workspace_parameters.header.stamp.secs, _x.req.workspace_parameters.header.stamp.nsecs))
      _x = self.req.workspace_parameters.header.frame_id
      length = len(_x)
      ...
      _x = self
      buff.write(_get_struct_6d3I().pack(_x.req.workspace_parameters.min_corner.x, _x.req.workspace_parameters.min_corner.y, _x.req.workspace_parameters.min_corner.z, _x.req.workspace_parameters.max_corner.x, _x.req.workspace_parameters.max_corner.y, _x.req.workspace_parameters.max_corner.z, _x.req.start_state.joint_state.header.seq, _x.req.start_state.joint_state.header.stamp.secs, _x.req.start_state.joint_state.header.stamp.nsecs))
      _x = self.req.start_state.joint_state.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.req.start_state.joint_state.name)
      buff.write(_struct_I.pack(length))
      for val1 in self.req.start_state.joint_state.name:
        length = len(val1)
        if python3 or type(val1) == unicode:
          val1 = val1.encode('utf-8')
          length = len(val1)
        buff.write(struct.Struct('<I%ss'%length).pack(length, val1))
      length = len(self.req.start_state.joint_state.position)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.req.start_state.joint_state.position))
      length = len(self.req.start_state.joint_state.velocity)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.req.start_state.joint_state.velocity))
      length = len(self.req.start_state.joint_state.effort)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.req.start_state.joint_state.effort))
      _x = self
      buff.write(_get_struct_3I().pack(_x.req.start_state.multi_dof_joint_state.header.seq, _x.req.start_state.multi_dof_joint_state.header.stamp.secs, _x.req.start_state.multi_dof_joint_state.header.stamp.nsecs))
      _x = self.req.start_state.multi_dof_joint_state.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.req.start_state.multi_dof_joint_state.joint_names)
      buff.write(_struct_I.pack(length))
      for val1 in self.req.start_state.multi_dof_joint_state.joint_names:
        length = len(val1)
        if python3 or type(val1) == unicode:
          val1 = val1.encode('utf-8')
          length = len(val1)
        buff.write(struct.Struct('<I%ss'%length).pack(length, val1))
      length = len(self.req.start_state.multi_dof_joint_state.transforms)
      buff.write(_struct_I.pack(length))
      for val1 in self.req.start_state.multi_dof_joint_state.transforms:
      ...
      length = len(self.req.start_state.multi_dof_joint_state.twist)
      buff.write(_struct_I.pack(length))
      for val1 in self.req.start_state.multi_dof_joint_state.twist:
        _v3 = val1.linear
        _x = _v3
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        _v4 = val1.angular
        _x = _v4
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
      length = len(self.req.start_state.multi_dof_joint_state.wrench)
      buff.write(_struct_I.pack(length))
      for val1 in self.req.start_state.multi_dof_joint_state.wrench:
        _v5 = val1.force
        _x = _v5
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        _v6 = val1.torque
        _x = _v6
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
      length = len(self.req.start_state.attached_collision_objects)
      buff.write(_struct_I.pack(length))
      for val1 in self.req.start_state.attached_collision_objects:
        _x = val1.link_name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
      ...
      _x = self.req.start_state.is_diff
      buff.write(_get_struct_B().pack(_x))
      length = len(self.req.goal_constraints)
      buff.write(_struct_I.pack(length))
      for val1 in self.req.goal_constraints:
        _x = val1.name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
      ...
      _x = self.req.path_constraints.name
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.req.path_constraints.joint_constraints)
      buff.write(_struct_I.pack(length))
      for val1 in self.req.path_constraints.joint_constraints:
        _x = val1.joint_name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
        ...
        _x = val1
        buff.write(_get_struct_4d().pack(_x.position, _x.tolerance_above, _x.tolerance_below, _x.weight))
      length = len(self.req.path_constraints.position_constraints)
      buff.write(_struct_I.pack(length))
      for val1 in self.req.path_constraints.position_constraints:
        _v49 = val1.header
        _x = _v49.seq
        buff.write(_get_struct_I().pack(_x))
        _v50 = _v49.stamp
        ...
        _x = val1.weight
        buff.write(_get_struct_d().pack(_x))
      length = len(self.req.path_constraints.orientation_constraints)
      buff.write(_struct_I.pack(length))
      for val1 in self.req.path_constraints.orientation_constraints:
        _v57 = val1.header
        _x = _v57.seq
        buff.write(_get_struct_I().pack(_x))
        _v58 = _v57.stamp
        ...
        _x = val1
        buff.write(_get_struct_3dBd().pack(_x.absolute_x_axis_tolerance, _x.absolute_y_axis_tolerance, _x.absolute_z_axis_tolerance, _x.parameterization, _x.weight))
      length = len(self.req.path_constraints.visibility_constraints)
      buff.write(_struct_I.pack(length))
      for val1 in self.req.path_constraints.visibility_constraints:
        ...
        _x = val1
        buff.write(_get_struct_2dBd().pack(_x.max_view_angle, _x.max_range_angle, _x.sensor_view_direction, _x.weight))
      length = len(self.req.trajectory_constraints.constraints)
      buff.write(_struct_I.pack(length))
      for val1 in self.req.trajectory_constraints.constraints:
        _x = val1.name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
        ...
        for val2 in val1.visibility_constraints:
          ...
          _x = val2
          buff.write(_get_struct_2dBd().pack(_x.max_view_angle, _x.max_range_angle, _x.sensor_view_direction, _x.weight))
      length = len(self.req.reference_trajectories)
      buff.write(_struct_I.pack(length))
      for val1 in self.req.reference_trajectories:
        _v95 = val1.header
        _x = _v95.seq
        buff.write(_get_struct_I().pack(_x))
        _v96 = _v95.stamp
        ...
        for val2 in val1.cartesian_trajectory:
          ...
          for val3 in val2.points:
            ...
            _x = _v112
            buff.write(_get_struct_2i().pack(_x.secs, _x.nsecs))
      _x = self.req.pipeline_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.req.planner_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.req.group_name
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_i3d().pack(_x.req.num_planning_attempts, _x.req.allowed_planning_time, _x.req.max_velocity_scaling_factor, _x.req.max_acceleration_scaling_factor))
      _x = self.req.cartesian_speed_end_effector_link
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_2d().pack(_x.req.max_cartesian_speed, _x.blend_radius))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.req.workspace_parameters.header.seq, _x.req.workspace_parameters.header.stamp.secs, _x.req.workspace_parameters.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      ...
      if python3:
        self.req.workspace_parameters.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.req.workspace_parameters.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 60
      (_x.req.workspace_parameters.min_corner.x, _x.req.workspace_parameters.min_corner.y, _x.req.workspace_parameters.min_corner.z, _x.req.workspace_parameters.max_corner.x, _x.req.workspace_parameters.max_corner.y, _x.req.workspace_parameters.max_corner.z, _x.req.start_state.joint_state.header.seq, _x.req.start_state.joint_state.header.stamp.secs, _x.req.start_state.joint_state.header.stamp.nsecs,) = _get_struct_6d3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.req.start_state.joint_state.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.req.start_state.joint_state.header.frame_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.req.start_state.joint_state.name = []
      for i in range(0, length):
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.req.start_state.joint_state.name.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.req.start_state.joint_state.position = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.req.start_state.joint_state.velocity = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.req.start_state.joint_state.effort = s.unpack(str[start:end])
      _x = self
      start = end
      end += 12
      (_x.req.start_state.multi_dof_joint_state.header.seq, _x.req.start_state.multi_dof_joint_state.header.stamp.secs, _x.req.start_state.multi_dof_joint_state.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.req.start_state.multi_dof_joint_state.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.req.start_state.multi_dof_joint_state.header.frame_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.req.start_state.multi_dof_joint_state.joint_names = []
      for i in range(0, length):
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.req.start_state.multi_dof_joint_state.joint_names.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.req.start_state.multi_dof_joint_state.transforms = []
      for i in range(0, length):
        ...
        self.req.start_state.multi_dof_joint_state.transforms.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.req.start_state.multi_dof_joint_state.twist = []
      for i in range(0, length):
        ...
        (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
        self.req.start_state.multi_dof_joint_state.twist.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.req.start_state.multi_dof_joint_state.wrench = []
      for i in range(0, length):
        ...
        (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
        self.req.start_state.multi_dof_joint_state.wrench.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.req.start_state.attached_collision_objects = []
      for i in range(0, length):
        ...
        self.req.start_state.attached_collision_objects.append(val1)
      start = end
      end += 1
      (self.req.start_state.is_diff,) = _get_struct_B().unpack(str[start:end])
      self.req.start_state.is_diff = bool(self.req.start_state.is_diff)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.req.goal_constraints = []
      for i in range(0, length):
        ...
        self.req.goal_constraints.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.req.path_constraints.name = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.req.path_constraints.name = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.req.path_constraints.joint_constraints = []
      for i in range(0, length):
        ...
        (_x.position, _x.tolerance_above, _x.tolerance_below, _x.weight,) = _get_struct_4d().unpack(str[start:end])
        self.req.path_constraints.joint_constraints.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.req.path_constraints.position_constraints = []
      for i in range(0, length):
        ...
        (val1.weight,) = _get_struct_d().unpack(str[start:end])
        self.req.path_constraints.position_constraints.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.req.path_constraints.orientation_constraints = []
      for i in range(0, length):
        ...
        (_x.absolute_x_axis_tolerance, _x.absolute_y_axis_tolerance, _x.absolute_z_axis_tolerance, _x.parameterization, _x.weight,) = _get_struct_3dBd().unpack(str[start:end])
        self.req.path_constraints.orientation_constraints.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.req.path_constraints.visibility_constraints = []
      for i in range(0, length):
        ...
        (_x.max_view_angle, _x.max_range_angle, _x.sensor_view_direction, _x.weight,) = _get_struct_2dBd().unpack(str[start:end])
        self.req.path_constraints.visibility_constraints.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.req.trajectory_constraints.constraints = []
      for i in range(0, length):
        val1 = moveit_msgs.msg.Constraints()
        start = end
        end += 4
        ...
        for i in range(0, length):
          ...
          (_x.max_view_angle, _x.max_range_angle, _x.sensor_view_direction, _x.weight,) = _get_struct_2dBd().unpack(str[start:end])
          val1.visibility_constraints.append(val2)
        self.req.trajectory_constraints.constraints.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.req.reference_trajectories = []
      for i in range(0, length):
        ...
        self.req.reference_trajectories.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.req.pipeline_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.req.pipeline_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.req.planner_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.req.planner_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.req.group_name = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.req.group_name = str[start:end]
      _x = self
      start = end
      end += 28
      (_x.req.num_planning_attempts, _x.req.allowed_planning_time, _x.req.max_velocity_scaling_factor, _x.req.max_acceleration_scaling_factor,) = _get_struct_i3d().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.req.cartesian_speed_end_effector_link = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.req.cartesian_speed_end_effector_link = str[start:end]
      _x = self
      start = end
      end += 16
      (_x.req.max_cartesian_speed, _x.blend_radius,) = _get_struct_2d().unpack(str[start:end])
      return self
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(self.req.start_state.joint_state.position.tostring())
      length = len(self.req.start_state.joint_state.velocity)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(self.req.start_state.joint_state.velocity.tostring())
      length = len(self.req.start_state.joint_state.effort)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(self.req.start_state.joint_state.effort.tostring())
      _x = self
      buff.write(_get_struct_3I().pack(_x.req.start_state.multi_dof_joint_state.header.seq, _x.req.start_state.multi_dof_joint_state.header.stamp.secs, _x.req.start_state.multi_dof_joint_state.header.stamp.nsecs))
      _x = self.req.start_state.multi_dof_joint_state.header.frame_id
      length = len(_x)
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.req.start_state.joint_state.position = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.req.start_state.joint_state.velocity = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.req.start_state.joint_state.effort = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      _x = self
      start = end
      end += 12
      (_x.req.start_state.multi_dof_joint_state.header.seq, _x.req.start_state.multi_dof_joint_state.header.stamp.secs, _x.req.start_state.multi_dof_joint_state.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
