...
class GetCartesianPathRequest(genpy.Message):
  _md5sum = "8174baea665a893e7f11a8af5022abab"
  _type = "moveit_msgs/GetCartesianPathRequest"
  _has_header = True  # flag to mark the presence of a Header object
  _full_text = """# Define the frame for the specified waypoints
Header header
...
Pose pose
"""
  __slots__ = ['header','start_state','group_name','link_name','waypoints','max_step','jump_threshold','prismatic_jump_threshold','revolute_jump_threshold','avoid_collisions','path_constraints','cartesian_speed_end_effector_link','max_cartesian_speed']
  _slot_types = ['std_msgs/Header','moveit_msgs/RobotState','string','string','geometry_msgs/Pose[]','float64','float64','float64','float64','bool','moveit_msgs/Constraints','string','float64']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,start_state,group_name,link_name,waypoints,max_step,jump_threshold,prismatic_jump_threshold,revolute_jump_threshold,avoid_collisions,path_constraints,cartesian_speed_end_effector_link,max_cartesian_speed
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.waypoints:
        ...
        buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
      _x = self
      buff.write(_get_struct_4dB().pack(_x.max_step, _x.jump_threshold, _x.prismatic_jump_threshold, _x.revolute_jump_threshold, _x.avoid_collisions))
      ...
      for val1 in self.path_constraints.position_constraints:
        ...
        _x = _v30
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        _v31 = val1.constraint_region
        length = len(_v31.primitives)
        buff.write(_struct_I.pack(length))
        for val3 in _v31.primitives:
          _x = val3.type
          buff.write(_get_struct_B().pack(_x))
          length = len(val3.dimensions)
          buff.write(_struct_I.pack(length))
          pattern = '<%sd'%length
          buff.write(struct.Struct(pattern).pack(*val3.dimensions))
        length = len(_v31.primitive_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v31.primitive_poses:
          _v32 = val3.position
          _x = _v32
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          ...
          _x = _v33
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        length = len(_v31.meshes)
        buff.write(_struct_I.pack(length))
        for val3 in _v31.meshes:
          length = len(val3.triangles)
          buff.write(_struct_I.pack(length))
          for val4 in val3.triangles:
            buff.write(_get_struct_3I().pack(*val4.vertex_indices))
          ...
          for val4 in val3.vertices:
            _x = val4
            buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        length = len(_v31.mesh_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v31.mesh_poses:
          _v34 = val3.position
          _x = _v34
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v57.id = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v63.key = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v63.key = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        if python3:
          _v63.db = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v63.db = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v57.primitives = []
      ...
      (_x.max_step, _x.jump_threshold, _x.prismatic_jump_threshold, _x.revolute_jump_threshold, _x.avoid_collisions,) = _get_struct_4dB().unpack(str[start:end])
      ...
      for i in range(0, length):
        ...
        if python3:
          ...
          val1.link_name = str[start:end]
        _v80 = val1.target_point_offset
        _x = _v80
        start = end
        end += 24
        (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
        _v81 = val1.constraint_region
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v81.primitives = []
        for i in range(0, length):
          ...
          val3.dimensions = s.unpack(str[start:end])
          _v81.primitives.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v81.primitive_poses = []
        for i in range(0, length):
          val3 = geometry_msgs.msg.Pose()
          _v82 = val3.position
          _x = _v82
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v81.primitive_poses.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v81.meshes = []
    ...
    try:
      ...
      for val1 in self.start_state.attached_collision_objects:
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
        length = len(_v122.joint_names)
        buff.write(_struct_I.pack(length))
        for val3 in _v122.joint_names:
          length = len(val3)
          if python3 or type(val3) == unicode:
            val3 = val3.encode('utf-8')
            length = len(val3)
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v157.id = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v163.key = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v163.key = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        if python3:
          _v163.db = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v163.db = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v157.primitives = []
        ...
        for i in range(0, length):
          ...
          _v175 = val3.time_from_start
          _x = _v175
          start = end
          end += 8
          (_x.secs, _x.nsecs,) = _get_struct_2i().unpack(str[start:end])
          _v172.points.append(val3)
        start = end
        end += 8
        (val1.weight,) = _get_struct_d().unpack(str[start:end])
        self.start_state.attached_collision_objects.append(val1)
      ...
      for i in range(0, length):
        ...
        if python3:
          ...
          val1.link_name = str[start:end]
        _v180 = val1.target_point_offset
        _x = _v180
        start = end
        end += 24
        (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
        _v181 = val1.constraint_region
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v181.primitives = []
        ...
        for i in range(0, length):
          ...
          (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
          _v183 = val3.orientation
          _x = _v183
          start = end
          end += 32
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v181.primitive_poses.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v181.meshes = []
        ...
        for i in range(0, length):
          ...
          (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
          _v185 = val3.orientation
          _x = _v185
          start = end
          end += 32
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v181.mesh_poses.append(val3)
        start = end
        end += 8
        (val1.weight,) = _get_struct_d().unpack(str[start:end])
        self.path_constraints.position_constraints.append(val1)
...
class GetCartesianPathResponse(genpy.Message):
  _md5sum = "15ee95715c86802ada727b6361c6f4d2"
    ...
    try:
      ...
      for val1 in self.start_state.attached_collision_objects:
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
        length = len(_v222.joint_names)
        buff.write(_struct_I.pack(length))
        for val3 in _v222.joint_names:
          length = len(val3)
          if python3 or type(val3) == unicode:
            val3 = val3.encode('utf-8')
            length = len(val3)
          buff.write(struct.Struct('<I%ss'%length).pack(length, val3))
        length = len(_v222.points)
        buff.write(_struct_I.pack(length))
        for val3 in _v222.points:
          length = len(val3.positions)
          buff.write(_struct_I.pack(length))
          pattern = '<%sd'%length
          buff.write(struct.Struct(pattern).pack(*val3.positions))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v240.id = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v240.id = str[start:end]
        _v246 = _v240.type
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        if python3:
          _v246.key = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v246.key = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        if python3:
          _v246.db = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v246.db = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v240.primitives = []
        for i in range(0, length):
          ...
          val3.dimensions = s.unpack(str[start:end])
          _v240.primitives.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v240.primitive_poses = []
        for i in range(0, length):
          val3 = geometry_msgs.msg.Pose()
          _v247 = val3.position
          _x = _v247
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v240.primitive_poses.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v240.meshes = []
        ...
        for i in range(0, length):
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v240.plane_poses.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v240.subframe_names = []
        for i in range(0, length):
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          ...
          if python3:
            ...
            val3 = str[start:end]
          _v240.subframe_names.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v240.subframe_poses = []
        for i in range(0, length):
          val3 = geometry_msgs.msg.Pose()
          _v253 = val3.position
          _x = _v253
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v240.subframe_poses.append(val3)
        start = end
        end += 1
        (_v240.operation,) = _get_struct_b().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
    ...
    try:
      ...
      for val1 in self.start_state.attached_collision_objects:
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
        length = len(_v273.primitives)
        buff.write(_struct_I.pack(length))
        for val3 in _v273.primitives:
          _x = val3.type
          buff.write(_get_struct_B().pack(_x))
          length = len(val3.dimensions)
          buff.write(_struct_I.pack(length))
          pattern = '<%sd'%length
          buff.write(val3.dimensions.tostring())
        length = len(_v273.primitive_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v273.primitive_poses:
          _v280 = val3.position
          _x = _v280
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          ...
          _x = _v281
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        length = len(_v273.meshes)
        buff.write(_struct_I.pack(length))
        for val3 in _v273.meshes:
          length = len(val3.triangles)
          buff.write(_struct_I.pack(length))
          for val4 in val3.triangles:
            buff.write(val4.vertex_indices.tostring())
          ...
          for val4 in val3.vertices:
            _x = val4
            buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        length = len(_v273.mesh_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v273.mesh_poses:
          _v282 = val3.position
          _x = _v282
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          ...
          _x = _v283
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        length = len(_v273.planes)
        buff.write(_struct_I.pack(length))
        for val3 in _v273.planes:
          buff.write(val3.coef.tostring())
        length = len(_v273.plane_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v273.plane_poses:
          _v284 = val3.position
          _x = _v284
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          ...
          _x = _v285
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        length = len(_v273.subframe_names)
        buff.write(_struct_I.pack(length))
        for val3 in _v273.subframe_names:
          length = len(val3)
          if python3 or type(val3) == unicode:
            val3 = val3.encode('utf-8')
            length = len(val3)
          buff.write(struct.Struct('<I%ss'%length).pack(length, val3))
        length = len(_v273.subframe_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v273.subframe_poses:
          _v286 = val3.position
          _x = _v286
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          _v287 = val3.orientation
          _x = _v287
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        _x = _v273.operation
        buff.write(_get_struct_b().pack(_x))
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
        length = len(_v288.joint_names)
        buff.write(_struct_I.pack(length))
        for val3 in _v288.joint_names:
          length = len(val3)
          if python3 or type(val3) == unicode:
            val3 = val3.encode('utf-8')
            length = len(val3)
          buff.write(struct.Struct('<I%ss'%length).pack(length, val3))
        length = len(_v288.points)
        buff.write(_struct_I.pack(length))
        for val3 in _v288.points:
          length = len(val3.positions)
          buff.write(_struct_I.pack(length))
          pattern = '<%sd'%length
          buff.write(val3.positions.tostring())
...
class GetCartesianPath(object):
  ...
  _md5sum = 'a40ea297aa815b862ba78b6ab76981e8'
