...
class MoveGroupActionGoal(genpy.Message):
  _md5sum = "152e336e337dce7cbe639f1bd9c65def"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.goal.request.reference_trajectories:
        ...
        for val2 in val1.cartesian_trajectory:
          ...
          for val3 in val2.points:
            ...
            _x = _v112
            buff.write(_get_struct_2i().pack(_x.secs, _x.nsecs))
      _x = self.goal.request.pipeline_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      _x = self.goal.request.cartesian_speed_end_effector_link
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.goal.request.max_cartesian_speed
      buff.write(_get_struct_d().pack(_x))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.goal.request.pipeline_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.goal.request.pipeline_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.goal.request.cartesian_speed_end_effector_link = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.goal.request.cartesian_speed_end_effector_link = str[start:end]
      start = end
      end += 8
      (self.goal.request.max_cartesian_speed,) = _get_struct_d().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
