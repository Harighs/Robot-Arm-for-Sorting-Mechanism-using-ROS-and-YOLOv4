...
class GetMotionPlanRequest(genpy.Message):
  _md5sum = "5459d2db10f706c7e69e5485e0b58672"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.motion_plan_request.reference_trajectories:
        ...
        for val2 in val1.cartesian_trajectory:
          ...
          for val3 in val2.points:
            ...
            _x = _v112
            buff.write(_get_struct_2i().pack(_x.secs, _x.nsecs))
      _x = self.motion_plan_request.pipeline_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      _x = self.motion_plan_request.cartesian_speed_end_effector_link
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.motion_plan_request.max_cartesian_speed
      buff.write(_get_struct_d().pack(_x))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.motion_plan_request.pipeline_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.motion_plan_request.pipeline_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.motion_plan_request.cartesian_speed_end_effector_link = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.motion_plan_request.cartesian_speed_end_effector_link = str[start:end]
      start = end
      end += 8
      (self.motion_plan_request.max_cartesian_speed,) = _get_struct_d().unpack(str[start:end])
      return self
...
class GetMotionPlanResponse(genpy.Message):
  _md5sum = "b87f68f66cd157fdfe416b1070b9ecb6"
    ...
    try:
      ...
      for val1 in self.motion_plan_response.trajectory_start.attached_collision_objects:
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
        length = len(_v455.primitives)
        buff.write(_struct_I.pack(length))
        for val3 in _v455.primitives:
          _x = val3.type
          buff.write(_get_struct_B().pack(_x))
          length = len(val3.dimensions)
          buff.write(_struct_I.pack(length))
          pattern = '<%sd'%length
          buff.write(struct.Struct(pattern).pack(*val3.dimensions))
        length = len(_v455.primitive_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v455.primitive_poses:
          _v462 = val3.position
          _x = _v462
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          _v463 = val3.orientation
          _x = _v463
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        length = len(_v455.meshes)
        buff.write(_struct_I.pack(length))
        for val3 in _v455.meshes:
          length = len(val3.triangles)
          buff.write(_struct_I.pack(length))
          for val4 in val3.triangles:
            buff.write(_get_struct_3I().pack(*val4.vertex_indices))
          ...
          for val4 in val3.vertices:
            _x = val4
            buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        length = len(_v455.mesh_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v455.mesh_poses:
          _v464 = val3.position
          _x = _v464
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          _v465 = val3.orientation
          _x = _v465
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        length = len(_v455.planes)
        buff.write(_struct_I.pack(length))
        for val3 in _v455.planes:
          buff.write(_get_struct_4d().pack(*val3.coef))
        length = len(_v455.plane_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v455.plane_poses:
          _v466 = val3.position
          _x = _v466
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          _v467 = val3.orientation
          _x = _v467
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        length = len(_v455.subframe_names)
        buff.write(_struct_I.pack(length))
        for val3 in _v455.subframe_names:
          length = len(val3)
          if python3 or type(val3) == unicode:
            val3 = val3.encode('utf-8')
            length = len(val3)
          buff.write(struct.Struct('<I%ss'%length).pack(length, val3))
        length = len(_v455.subframe_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v455.subframe_poses:
          _v468 = val3.position
          _x = _v468
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          _v469 = val3.orientation
          _x = _v469
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        _x = _v455.operation
        buff.write(_get_struct_b().pack(_x))
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
        length = len(_v470.joint_names)
        buff.write(_struct_I.pack(length))
        for val3 in _v470.joint_names:
          length = len(val3)
          if python3 or type(val3) == unicode:
            val3 = val3.encode('utf-8')
            length = len(val3)
          buff.write(struct.Struct('<I%ss'%length).pack(length, val3))
        length = len(_v470.points)
        buff.write(_struct_I.pack(length))
        for val3 in _v470.points:
          length = len(val3.positions)
          buff.write(_struct_I.pack(length))
          pattern = '<%sd'%length
          buff.write(struct.Struct(pattern).pack(*val3.positions))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (_v489.seq,) = _get_struct_I().unpack(str[start:end])
        _v490 = _v489.stamp
        _x = _v490
        start = end
        end += 8
        ...
        if python3:
          _v489.frame_id = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v489.frame_id = str[start:end]
        _v491 = _v488.pose
        _v492 = _v491.position
        _x = _v492
        start = end
        end += 24
        (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
        _v493 = _v491.orientation
        _x = _v493
        start = end
        end += 32
        (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
        ...
        if python3:
          _v488.id = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v488.id = str[start:end]
        _v494 = _v488.type
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        if python3:
          _v494.key = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v494.key = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        if python3:
          _v494.db = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v494.db = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v488.primitives = []
        for i in range(0, length):
          ...
          val3.dimensions = s.unpack(str[start:end])
          _v488.primitives.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v488.primitive_poses = []
        for i in range(0, length):
          val3 = geometry_msgs.msg.Pose()
          _v495 = val3.position
          _x = _v495
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v488.primitive_poses.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v488.meshes = []
        ...
        for i in range(0, length):
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v488.plane_poses.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v488.subframe_names = []
        for i in range(0, length):
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          ...
          if python3:
            ...
            val3 = str[start:end]
          _v488.subframe_names.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v488.subframe_poses = []
        for i in range(0, length):
          val3 = geometry_msgs.msg.Pose()
          _v501 = val3.position
          _x = _v501
          ...
          (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
          _v502 = val3.orientation
          _x = _v502
          start = end
          end += 32
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v488.subframe_poses.append(val3)
        start = end
        end += 1
        (_v488.operation,) = _get_struct_b().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
        for i in range(0, length):
          ...
          if python3:
            ...
            val2 = str[start:end]
          val1.touch_links.append(val2)
        _v503 = val1.detach_posture
        _v504 = _v503.header
        start = end
        end += 4
        (_v504.seq,) = _get_struct_I().unpack(str[start:end])
        _v505 = _v504.stamp
        _x = _v505
        start = end
        end += 8
        ...
        if python3:
          _v504.frame_id = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v504.frame_id = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v503.joint_names = []
        ...
        for i in range(0, length):
          ...
          val3.effort = s.unpack(str[start:end])
          _v506 = val3.time_from_start
          _x = _v506
          start = end
          end += 8
          (_x.secs, _x.nsecs,) = _get_struct_2i().unpack(str[start:end])
          _v503.points.append(val3)
        start = end
        end += 8
        (val1.weight,) = _get_struct_d().unpack(str[start:end])
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      for val1 in self.motion_plan_response.trajectory_start.attached_collision_objects:
        ...
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
        _v524 = _v521.pose
        _v525 = _v524.position
        _x = _v525
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        _v526 = _v524.orientation
        _x = _v526
        buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        _x = _v521.id
        length = len(_x)
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
        length = len(_v521.primitives)
        buff.write(_struct_I.pack(length))
        for val3 in _v521.primitives:
          _x = val3.type
          buff.write(_get_struct_B().pack(_x))
          length = len(val3.dimensions)
          buff.write(_struct_I.pack(length))
          pattern = '<%sd'%length
          buff.write(val3.dimensions.tostring())
        length = len(_v521.primitive_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v521.primitive_poses:
          _v528 = val3.position
          _x = _v528
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          ...
          _x = _v529
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        length = len(_v521.meshes)
        buff.write(_struct_I.pack(length))
        for val3 in _v521.meshes:
          length = len(val3.triangles)
          buff.write(_struct_I.pack(length))
          for val4 in val3.triangles:
            buff.write(val4.vertex_indices.tostring())
          ...
          for val4 in val3.vertices:
            _x = val4
            buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        length = len(_v521.mesh_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v521.mesh_poses:
          _v530 = val3.position
          _x = _v530
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          ...
          _x = _v531
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        length = len(_v521.planes)
        buff.write(_struct_I.pack(length))
        for val3 in _v521.planes:
          buff.write(val3.coef.tostring())
        length = len(_v521.plane_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v521.plane_poses:
          _v532 = val3.position
          _x = _v532
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          ...
          _x = _v533
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        length = len(_v521.subframe_names)
        buff.write(_struct_I.pack(length))
        for val3 in _v521.subframe_names:
          length = len(val3)
          if python3 or type(val3) == unicode:
            val3 = val3.encode('utf-8')
            length = len(val3)
          buff.write(struct.Struct('<I%ss'%length).pack(length, val3))
        length = len(_v521.subframe_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v521.subframe_poses:
          _v534 = val3.position
          _x = _v534
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
        length = len(_v536.joint_names)
        buff.write(_struct_I.pack(length))
        for val3 in _v536.joint_names:
          length = len(val3)
          if python3 or type(val3) == unicode:
            val3 = val3.encode('utf-8')
            length = len(val3)
          buff.write(struct.Struct('<I%ss'%length).pack(length, val3))
        length = len(_v536.points)
        buff.write(_struct_I.pack(length))
        for val3 in _v536.points:
          length = len(val3.positions)
          buff.write(_struct_I.pack(length))
          pattern = '<%sd'%length
          buff.write(val3.positions.tostring())
...
class GetMotionPlan(object):
  ...
  _md5sum = '29c3c85c8a4c241f7588a9b4da235097'
