...
class MoveGroupAction(genpy.Message):
  _md5sum = "6337a63f836aa32e02cee901b8c83a22"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.action_goal.goal.request.reference_trajectories:
        ...
        for val2 in val1.cartesian_trajectory:
          ...
          for val3 in val2.points:
            ...
            _x = _v112
            buff.write(_get_struct_2i().pack(_x.secs, _x.nsecs))
      _x = self.action_goal.goal.request.pipeline_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      _x = self.action_goal.goal.request.cartesian_speed_end_effector_link
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.action_goal.goal.request.max_cartesian_speed
      buff.write(_get_struct_d().pack(_x))
      ...
      for val1 in self.action_result.result.trajectory_start.attached_collision_objects:
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
        length = len(_v164.primitives)
        buff.write(_struct_I.pack(length))
        for val3 in _v164.primitives:
          _x = val3.type
          buff.write(_get_struct_B().pack(_x))
          length = len(val3.dimensions)
          buff.write(_struct_I.pack(length))
          pattern = '<%sd'%length
          buff.write(struct.Struct(pattern).pack(*val3.dimensions))
        length = len(_v164.primitive_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v164.primitive_poses:
          _v171 = val3.position
          _x = _v171
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          ...
          _x = _v172
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        length = len(_v164.meshes)
        buff.write(_struct_I.pack(length))
        for val3 in _v164.meshes:
          length = len(val3.triangles)
          buff.write(_struct_I.pack(length))
          for val4 in val3.triangles:
            buff.write(_get_struct_3I().pack(*val4.vertex_indices))
          ...
          for val4 in val3.vertices:
            _x = val4
            buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        length = len(_v164.mesh_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v164.mesh_poses:
          _v173 = val3.position
          _x = _v173
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          ...
          _x = _v174
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        length = len(_v164.planes)
        buff.write(_struct_I.pack(length))
        for val3 in _v164.planes:
          buff.write(_get_struct_4d().pack(*val3.coef))
        length = len(_v164.plane_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v164.plane_poses:
          _v175 = val3.position
          _x = _v175
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          ...
          _x = _v176
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        length = len(_v164.subframe_names)
        buff.write(_struct_I.pack(length))
        for val3 in _v164.subframe_names:
          length = len(val3)
          if python3 or type(val3) == unicode:
            val3 = val3.encode('utf-8')
            length = len(val3)
          buff.write(struct.Struct('<I%ss'%length).pack(length, val3))
        length = len(_v164.subframe_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v164.subframe_poses:
          _v177 = val3.position
          _x = _v177
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v205.id = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v205.id = str[start:end]
        _v211 = _v205.type
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        if python3:
          _v211.key = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v211.db = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        for i in range(0, length):
          ...
          _v205.primitives.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v205.primitive_poses = []
        for i in range(0, length):
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v205.primitive_poses.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v205.meshes = []
        ...
        for i in range(0, length):
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v205.plane_poses.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v205.subframe_names = []
        for i in range(0, length):
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          ...
          if python3:
            ...
            val3 = str[start:end]
          _v205.subframe_names.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v205.subframe_poses = []
        for i in range(0, length):
          val3 = geometry_msgs.msg.Pose()
          _v218 = val3.position
          _x = _v218
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v205.subframe_poses.append(val3)
        start = end
        end += 1
        (_v205.operation,) = _get_struct_b().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
      ...
      for i in range(0, length):
        ...
        for i in range(0, length):
          ...
          _v226 = val2.target_point_offset
          _x = _v226
          start = end
          end += 24
          (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
          _v227 = val2.constraint_region
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          _v227.primitives = []
          ...
          for i in range(0, length):
            ...
            (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
            _v229 = val4.orientation
            _x = _v229
            start = end
            end += 32
            (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
            _v227.primitive_poses.append(val4)
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          _v227.meshes = []
          ...
          for i in range(0, length):
            ...
            (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
            _v231 = val4.orientation
            _x = _v231
            start = end
            end += 32
            (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
            _v227.mesh_poses.append(val4)
          start = end
          end += 8
      ...
      for i in range(0, length):
        ...
        for i in range(0, length):
          ...
          if python3:
            ...
            val2.link_name = str[start:end]
          _v272 = val2.target_point_offset
          _x = _v272
          start = end
          end += 24
          (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
          _v273 = val2.constraint_region
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          _v273.primitives = []
          ...
          for i in range(0, length):
            ...
            (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
            _v275 = val4.orientation
            _x = _v275
            start = end
            end += 32
            (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
            _v273.primitive_poses.append(val4)
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          _v273.meshes = []
          ...
          for i in range(0, length):
            ...
            (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
            _v277 = val4.orientation
            _x = _v277
            start = end
            end += 32
            (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
            _v273.mesh_poses.append(val4)
          start = end
          end += 8
          (val2.weight,) = _get_struct_d().unpack(str[start:end])
          val1.position_constraints.append(val2)
      ...
      if python3:
        self.action_goal.goal.request.pipeline_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_goal.goal.request.pipeline_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_goal.goal.request.cartesian_speed_end_effector_link = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_goal.goal.request.cartesian_speed_end_effector_link = str[start:end]
      start = end
      end += 8
      (self.action_goal.goal.request.max_cartesian_speed,) = _get_struct_d().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      for i in range(0, length):
        ...
        if python3:
          _v317.id = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v317.id = str[start:end]
        _v323 = _v317.type
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        for i in range(0, length):
          ...
          val3.dimensions = s.unpack(str[start:end])
          _v317.primitives.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v317.primitive_poses = []
        for i in range(0, length):
          val3 = geometry_msgs.msg.Pose()
          _v324 = val3.position
          _x = _v324
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v317.primitive_poses.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v317.meshes = []
        ...
        for i in range(0, length):
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v317.plane_poses.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v317.subframe_names = []
        for i in range(0, length):
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          ...
          if python3:
            ...
            val3 = str[start:end]
          _v317.subframe_names.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v317.subframe_poses = []
        for i in range(0, length):
          val3 = geometry_msgs.msg.Pose()
          _v330 = val3.position
          _x = _v330
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v317.subframe_poses.append(val3)
        start = end
        end += 1
        (_v317.operation,) = _get_struct_b().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
        ...
        for i in range(0, length):
          ...
          val3.effort = s.unpack(str[start:end])
          _v335 = val3.time_from_start
          _x = _v335
          start = end
          end += 8
          (_x.secs, _x.nsecs,) = _get_struct_2i().unpack(str[start:end])
          _v332.points.append(val3)
        start = end
        end += 8
        (val1.weight,) = _get_struct_d().unpack(str[start:end])
      ...
      for i in range(0, length):
        ...
        _v338 = val1.transform
        _v339 = _v338.translation
        _x = _v339
        start = end
        end += 24
        (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
        _v340 = _v338.rotation
        _x = _v340
        start = end
        end += 32
        (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
      ...
      for i in range(0, length):
        ...
        if python3:
          _v347.key = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v347.key = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        if python3:
          _v347.db = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v347.db = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.primitives = []
      ...
      for i in range(0, length):
        ...
        if python3:
          _v362.id = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v362.id = str[start:end]
        _v368 = _v362.type
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        if python3:
          _v368.key = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v368.key = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        if python3:
          _v368.db = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v368.db = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v362.primitives = []
        for i in range(0, length):
          ...
          val3.dimensions = s.unpack(str[start:end])
          _v362.primitives.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v362.primitive_poses = []
        for i in range(0, length):
          val3 = geometry_msgs.msg.Pose()
          _v369 = val3.position
          _x = _v369
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v362.primitive_poses.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v362.meshes = []
        ...
        for i in range(0, length):
          ...
          (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
          _v374 = val3.orientation
          _x = _v374
          start = end
          end += 32
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v362.plane_poses.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v362.subframe_names = []
        for i in range(0, length):
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          ...
          if python3:
            ...
            val3 = str[start:end]
          _v362.subframe_names.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v362.subframe_poses = []
        for i in range(0, length):
          val3 = geometry_msgs.msg.Pose()
          _v375 = val3.position
          _x = _v375
          ...
          (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
          _v376 = val3.orientation
          _x = _v376
          start = end
          end += 32
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v362.subframe_poses.append(val3)
        start = end
        end += 1
        (_v362.operation,) = _get_struct_b().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
        ...
        for i in range(0, length):
          ...
          val3.effort = s.unpack(str[start:end])
          _v380 = val3.time_from_start
          _x = _v380
          start = end
          end += 8
          (_x.secs, _x.nsecs,) = _get_struct_2i().unpack(str[start:end])
          _v377.points.append(val3)
        start = end
        end += 8
        (val1.weight,) = _get_struct_d().unpack(str[start:end])
    ...
    try:
      ...
      for val1 in self.action_goal.goal.request.start_state.attached_collision_objects:
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
        length = len(_v403.primitives)
        buff.write(_struct_I.pack(length))
        for val3 in _v403.primitives:
          _x = val3.type
          buff.write(_get_struct_B().pack(_x))
          length = len(val3.dimensions)
          buff.write(_struct_I.pack(length))
        ...
        length = len(_v403.primitive_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v403.primitive_poses:
          _v410 = val3.position
          _x = _v410
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          _v411 = val3.orientation
          _x = _v411
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        length = len(_v403.meshes)
        buff.write(_struct_I.pack(length))
        for val3 in _v403.meshes:
          length = len(val3.triangles)
          buff.write(_struct_I.pack(length))
          for val4 in val3.triangles:
          ...
          for val4 in val3.vertices:
            _x = val4
            buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        length = len(_v403.mesh_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v403.mesh_poses:
          _v412 = val3.position
          _x = _v412
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          _v413 = val3.orientation
          _x = _v413
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        length = len(_v403.planes)
        buff.write(_struct_I.pack(length))
        for val3 in _v403.planes:
          buff.write(val3.coef.tostring())
        length = len(_v403.plane_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v403.plane_poses:
          _v414 = val3.position
          _x = _v414
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          _v415 = val3.orientation
          _x = _v415
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        length = len(_v403.subframe_names)
        buff.write(_struct_I.pack(length))
        for val3 in _v403.subframe_names:
          length = len(val3)
          if python3 or type(val3) == unicode:
            val3 = val3.encode('utf-8')
            length = len(val3)
          buff.write(struct.Struct('<I%ss'%length).pack(length, val3))
        length = len(_v403.subframe_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v403.subframe_poses:
          _v416 = val3.position
          _x = _v416
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
        length = len(_v418.joint_names)
        buff.write(_struct_I.pack(length))
        for val3 in _v418.joint_names:
          length = len(val3)
          if python3 or type(val3) == unicode:
            val3 = val3.encode('utf-8')
            length = len(val3)
          buff.write(struct.Struct('<I%ss'%length).pack(length, val3))
        length = len(_v418.points)
        buff.write(_struct_I.pack(length))
        for val3 in _v418.points:
          length = len(val3.positions)
          buff.write(_struct_I.pack(length))
          pattern = '<%sd'%length
      ...
      for val1 in self.action_goal.goal.request.goal_constraints:
        ...
        for val2 in val1.position_constraints:
          ...
          if python3 or type(_x) == unicode:
            ...
            length = len(_x)
          buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
          _v424 = val2.target_point_offset
          _x = _v424
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          _v425 = val2.constraint_region
          length = len(_v425.primitives)
          buff.write(_struct_I.pack(length))
          for val4 in _v425.primitives:
            _x = val4.type
            buff.write(_get_struct_B().pack(_x))
            length = len(val4.dimensions)
            buff.write(_struct_I.pack(length))
          ...
          length = len(_v425.primitive_poses)
          buff.write(_struct_I.pack(length))
          for val4 in _v425.primitive_poses:
            _v426 = val4.position
            _x = _v426
            buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
            _v427 = val4.orientation
            _x = _v427
            buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
          length = len(_v425.meshes)
          buff.write(_struct_I.pack(length))
          for val4 in _v425.meshes:
            length = len(val4.triangles)
            buff.write(_struct_I.pack(length))
            for val5 in val4.triangles:
            ...
            for val5 in val4.vertices:
              _x = val5
              buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          length = len(_v425.mesh_poses)
          buff.write(_struct_I.pack(length))
          for val4 in _v425.mesh_poses:
            _v428 = val4.position
            _x = _v428
            buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
            _v429 = val4.orientation
            _x = _v429
            buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
          _x = val2.weight
          buff.write(_get_struct_d().pack(_x))
      ...
      for val1 in self.action_goal.goal.request.path_constraints.position_constraints:
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
        _v447 = val1.target_point_offset
        _x = _v447
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        _v448 = val1.constraint_region
        length = len(_v448.primitives)
        buff.write(_struct_I.pack(length))
        for val3 in _v448.primitives:
          _x = val3.type
          buff.write(_get_struct_B().pack(_x))
          length = len(val3.dimensions)
          buff.write(_struct_I.pack(length))
          pattern = '<%sd'%length
          buff.write(val3.dimensions.tostring())
        length = len(_v448.primitive_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v448.primitive_poses:
          _v449 = val3.position
          _x = _v449
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          ...
          _x = _v450
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        length = len(_v448.meshes)
        buff.write(_struct_I.pack(length))
        for val3 in _v448.meshes:
          length = len(val3.triangles)
          buff.write(_struct_I.pack(length))
          for val4 in val3.triangles:
            buff.write(val4.vertex_indices.tostring())
          ...
          for val4 in val3.vertices:
            _x = val4
            buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        length = len(_v448.mesh_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v448.mesh_poses:
          _v451 = val3.position
          _x = _v451
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
      ...
      for val1 in self.action_goal.goal.request.trajectory_constraints.constraints:
        ...
        for val2 in val1.position_constraints:
          ...
          if python3 or type(_x) == unicode:
            ...
            length = len(_x)
          buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
          _v470 = val2.target_point_offset
          _x = _v470
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          _v471 = val2.constraint_region
          length = len(_v471.primitives)
          buff.write(_struct_I.pack(length))
          for val4 in _v471.primitives:
            _x = val4.type
            buff.write(_get_struct_B().pack(_x))
            length = len(val4.dimensions)
            buff.write(_struct_I.pack(length))
            pattern = '<%sd'%length
            buff.write(val4.dimensions.tostring())
          length = len(_v471.primitive_poses)
          buff.write(_struct_I.pack(length))
          for val4 in _v471.primitive_poses:
            _v472 = val4.position
            _x = _v472
            buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
            _v473 = val4.orientation
            _x = _v473
            buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
          length = len(_v471.meshes)
          buff.write(_struct_I.pack(length))
          for val4 in _v471.meshes:
            length = len(val4.triangles)
            buff.write(_struct_I.pack(length))
            for val5 in val4.triangles:
              buff.write(val5.vertex_indices.tostring())
            ...
            for val5 in val4.vertices:
              _x = val5
              buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          length = len(_v471.mesh_poses)
          buff.write(_struct_I.pack(length))
          for val4 in _v471.mesh_poses:
            _v474 = val4.position
            _x = _v474
            buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
            _v475 = val4.orientation
            _x = _v475
            buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
          _x = val2.weight
          buff.write(_get_struct_d().pack(_x))
      ...
      for val1 in self.action_goal.goal.planning_options.planning_scene_diff.fixed_frame_transforms:
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
        _v536 = val1.transform
        _v537 = _v536.translation
        _x = _v537
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        _v538 = _v536.rotation
        _x = _v538
        buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
      length = len(self.action_goal.goal.planning_options.planning_scene_diff.allowed_collision_matrix.entry_names)
      buff.write(_struct_I.pack(length))
      ...
      for val1 in self.action_goal.goal.planning_options.planning_scene_diff.world.collision_objects:
        ...
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
        _v542 = val1.pose
        _v543 = _v542.position
        _x = _v543
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        _v544 = _v542.orientation
        _x = _v544
        buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        _x = val1.id
        length = len(_x)
      ...
      for val1 in self.action_result.result.trajectory_start.attached_collision_objects:
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
        length = len(_v560.primitives)
        buff.write(_struct_I.pack(length))
        for val3 in _v560.primitives:
          _x = val3.type
          buff.write(_get_struct_B().pack(_x))
          length = len(val3.dimensions)
          buff.write(_struct_I.pack(length))
          pattern = '<%sd'%length
          buff.write(val3.dimensions.tostring())
        length = len(_v560.primitive_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v560.primitive_poses:
          _v567 = val3.position
          _x = _v567
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          ...
          _x = _v568
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        length = len(_v560.meshes)
        buff.write(_struct_I.pack(length))
        for val3 in _v560.meshes:
          length = len(val3.triangles)
          buff.write(_struct_I.pack(length))
          for val4 in val3.triangles:
            buff.write(val4.vertex_indices.tostring())
          ...
          for val4 in val3.vertices:
            _x = val4
            buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        length = len(_v560.mesh_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v560.mesh_poses:
          _v569 = val3.position
          _x = _v569
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          ...
          _x = _v570
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        length = len(_v560.planes)
        buff.write(_struct_I.pack(length))
        for val3 in _v560.planes:
          buff.write(val3.coef.tostring())
        length = len(_v560.plane_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v560.plane_poses:
          _v571 = val3.position
          _x = _v571
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          ...
          _x = _v572
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        length = len(_v560.subframe_names)
        buff.write(_struct_I.pack(length))
        for val3 in _v560.subframe_names:
          length = len(val3)
          if python3 or type(val3) == unicode:
            val3 = val3.encode('utf-8')
            length = len(val3)
          buff.write(struct.Struct('<I%ss'%length).pack(length, val3))
        length = len(_v560.subframe_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v560.subframe_poses:
          _v573 = val3.position
          _x = _v573
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
        length = len(_v575.joint_names)
        buff.write(_struct_I.pack(length))
        for val3 in _v575.joint_names:
          length = len(val3)
          if python3 or type(val3) == unicode:
            val3 = val3.encode('utf-8')
            length = len(val3)
          buff.write(struct.Struct('<I%ss'%length).pack(length, val3))
        length = len(_v575.points)
        buff.write(_struct_I.pack(length))
        for val3 in _v575.points:
          length = len(val3.positions)
          buff.write(_struct_I.pack(length))
          pattern = '<%sd'%length
          buff.write(val3.positions.tostring())
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (_v602.seq,) = _get_struct_I().unpack(str[start:end])
        _v603 = _v602.stamp
        _x = _v603
        start = end
        end += 8
        ...
        if python3:
          _v602.frame_id = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v602.frame_id = str[start:end]
        _v604 = _v601.pose
        ...
        if python3:
          _v601.id = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v601.id = str[start:end]
        _v607 = _v601.type
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        if python3:
          _v607.key = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v607.key = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        if python3:
          _v607.db = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v607.db = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v601.primitives = []
        for i in range(0, length):
          ...
          _v601.primitives.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v601.primitive_poses = []
        for i in range(0, length):
          val3 = geometry_msgs.msg.Pose()
          _v608 = val3.position
          _x = _v608
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v601.primitive_poses.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v601.meshes = []
        ...
        for i in range(0, length):
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v601.plane_poses.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v601.subframe_names = []
        for i in range(0, length):
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          ...
          if python3:
            ...
            val3 = str[start:end]
          _v601.subframe_names.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v601.subframe_poses = []
        for i in range(0, length):
          val3 = geometry_msgs.msg.Pose()
          _v614 = val3.position
          _x = _v614
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v601.subframe_poses.append(val3)
        start = end
        end += 1
        (_v601.operation,) = _get_struct_b().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
        ...
        (_v617.seq,) = _get_struct_I().unpack(str[start:end])
        _v618 = _v617.stamp
        _x = _v618
        start = end
        end += 8
        ...
        if python3:
          _v617.frame_id = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v617.frame_id = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v616.joint_names = []
      ...
      for i in range(0, length):
        ...
        for i in range(0, length):
          ...
          (_v620.seq,) = _get_struct_I().unpack(str[start:end])
          _v621 = _v620.stamp
          _x = _v621
          start = end
          end += 8
          ...
          if python3:
            _v620.frame_id = str[start:end].decode('utf-8', 'rosmsg')
          else:
            _v620.frame_id = str[start:end]
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          start = end
          ...
          if python3:
            ...
            val2.link_name = str[start:end]
          _v622 = val2.target_point_offset
          _x = _v622
          start = end
          end += 24
          (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
          _v623 = val2.constraint_region
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          _v623.primitives = []
          for i in range(0, length):
            ...
            _v623.primitives.append(val4)
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          _v623.primitive_poses = []
          for i in range(0, length):
            val4 = geometry_msgs.msg.Pose()
            _v624 = val4.position
            _x = _v624
            ...
            (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
            _v625 = val4.orientation
            _x = _v625
            start = end
            end += 32
            (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
            _v623.primitive_poses.append(val4)
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          _v623.meshes = []
          ...
          for i in range(0, length):
            ...
            (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
            _v627 = val4.orientation
            _x = _v627
            start = end
            end += 32
            (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
            _v623.mesh_poses.append(val4)
          start = end
          end += 8
          (val2.weight,) = _get_struct_d().unpack(str[start:end])
          val1.position_constraints.append(val2)
        ...
        for i in range(0, length):
          ...
          (val2.cone_sides,) = _get_struct_i().unpack(str[start:end])
          _v637 = val2.sensor_pose
          _v638 = _v637.header
          start = end
          end += 4
          (_v638.seq,) = _get_struct_I().unpack(str[start:end])
          _v639 = _v638.stamp
          _x = _v639
          start = end
          end += 8
          ...
          if python3:
            _v638.frame_id = str[start:end].decode('utf-8', 'rosmsg')
          else:
            _v638.frame_id = str[start:end]
          _v640 = _v637.pose
          _v641 = _v640.position
          _x = _v641
          start = end
          end += 24
          (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
          _v642 = _v640.orientation
          _x = _v642
          start = end
          end += 32
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
      ...
      for i in range(0, length):
        ...
        (_v643.seq,) = _get_struct_I().unpack(str[start:end])
        _v644 = _v643.stamp
        _x = _v644
        start = end
        end += 8
        ...
        if python3:
          _v643.frame_id = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v643.frame_id = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        if python3:
          ...
          val1.link_name = str[start:end]
        _v645 = val1.target_point_offset
        _x = _v645
        start = end
        end += 24
        (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
        _v646 = val1.constraint_region
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v646.primitives = []
        for i in range(0, length):
          ...
          val3.dimensions = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
          _v646.primitives.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v646.primitive_poses = []
        for i in range(0, length):
          val3 = geometry_msgs.msg.Pose()
          _v647 = val3.position
          _x = _v647
          ...
          (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
          _v648 = val3.orientation
          _x = _v648
          start = end
          end += 32
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v646.primitive_poses.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v646.meshes = []
        ...
        for i in range(0, length):
          ...
          (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
          _v650 = val3.orientation
          _x = _v650
          start = end
          end += 32
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v646.mesh_poses.append(val3)
        start = end
        end += 8
        (val1.weight,) = _get_struct_d().unpack(str[start:end])
        self.action_goal.goal.request.path_constraints.position_constraints.append(val1)
      ...
      for i in range(0, length):
        ...
        if python3:
          _v655.frame_id = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        (val1.cone_sides,) = _get_struct_i().unpack(str[start:end])
        _v660 = val1.sensor_pose
        _v661 = _v660.header
        start = end
        end += 4
        (_v661.seq,) = _get_struct_I().unpack(str[start:end])
        _v662 = _v661.stamp
        _x = _v662
        start = end
        end += 8
        ...
        if python3:
          _v661.frame_id = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v661.frame_id = str[start:end]
        _v663 = _v660.pose
        _v664 = _v663.position
        _x = _v664
        start = end
        end += 24
        (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
        _v665 = _v663.orientation
        _x = _v665
        start = end
        end += 32
        (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
      ...
      for i in range(0, length):
        ...
        for i in range(0, length):
          ...
          if python3:
            ...
            val2.link_name = str[start:end]
          _v668 = val2.target_point_offset
          _x = _v668
          start = end
          end += 24
          (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
          _v669 = val2.constraint_region
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          _v669.primitives = []
          for i in range(0, length):
            ...
            val4.dimensions = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
            _v669.primitives.append(val4)
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          _v669.primitive_poses = []
          for i in range(0, length):
            val4 = geometry_msgs.msg.Pose()
            _v670 = val4.position
            _x = _v670
            ...
            (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
            _v671 = val4.orientation
            _x = _v671
            start = end
            end += 32
            (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
            _v669.primitive_poses.append(val4)
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          _v669.meshes = []
          ...
          for i in range(0, length):
            ...
            (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
            _v673 = val4.orientation
            _x = _v673
            start = end
            end += 32
            (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
            _v669.mesh_poses.append(val4)
          start = end
          end += 8
          (val2.weight,) = _get_struct_d().unpack(str[start:end])
          val1.position_constraints.append(val2)
        ...
        for i in range(0, length):
          ...
          _v680 = _v677.pose
          _v681 = _v680.position
          _x = _v681
          start = end
          end += 24
          (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
          _v682 = _v680.orientation
          _x = _v682
          start = end
          end += 32
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
      ...
      for i in range(0, length):
        ...
        (_v689.seq,) = _get_struct_I().unpack(str[start:end])
        _v690 = _v689.stamp
        _x = _v690
        start = end
        end += 8
        ...
        if python3:
          _v689.frame_id = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v689.frame_id = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.joint_trajectory = []
        for i in range(0, length):
          ...
          (_v691.seq,) = _get_struct_I().unpack(str[start:end])
          _v692 = _v691.stamp
          _x = _v692
          start = end
          end += 8
          ...
          if python3:
            _v691.frame_id = str[start:end].decode('utf-8', 'rosmsg')
          else:
            _v691.frame_id = str[start:end]
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          val2.joint_names = []
        ...
        for i in range(0, length):
          ...
          (_v694.seq,) = _get_struct_I().unpack(str[start:end])
          _v695 = _v694.stamp
          _x = _v695
          start = end
          end += 8
          ...
          if python3:
            _v694.frame_id = str[start:end].decode('utf-8', 'rosmsg')
          else:
            _v694.frame_id = str[start:end]
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          start = end
          ...
          for i in range(0, length):
            ...
            _v696 = val3.point
            _v697 = _v696.pose
            _v698 = _v697.position
            _x = _v698
            start = end
            end += 24
            (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
            _v699 = _v697.orientation
            _x = _v699
            start = end
            end += 32
            (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
            _v700 = _v696.velocity
            _v701 = _v700.linear
            _x = _v701
            start = end
            end += 24
      ...
      for i in range(0, length):
        ...
        if python3:
          _v713.id = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v719.key = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v719.key = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        if python3:
          _v719.db = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v719.db = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v713.primitives = []
        ...
        for i in range(0, length):
          ...
          if python3:
            ...
            val2 = str[start:end]
          val1.touch_links.append(val2)
        _v728 = val1.detach_posture
        _v729 = _v728.header
        start = end
        end += 4
        (_v729.seq,) = _get_struct_I().unpack(str[start:end])
        _v730 = _v729.stamp
        _x = _v730
        start = end
        end += 8
        ...
        if python3:
          _v729.frame_id = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v729.frame_id = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v728.joint_names = []
        ...
        for i in range(0, length):
          ...
          val3.effort = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
          _v731 = val3.time_from_start
          _x = _v731
          start = end
          end += 8
          (_x.secs, _x.nsecs,) = _get_struct_2i().unpack(str[start:end])
          _v728.points.append(val3)
        start = end
        end += 8
        (val1.weight,) = _get_struct_d().unpack(str[start:end])
        self.action_goal.goal.planning_options.planning_scene_diff.robot_state.attached_collision_objects.append(val1)
      ...
      for i in range(0, length):
        ...
        if python3:
          ...
          val1.child_frame_id = str[start:end]
        _v734 = val1.transform
        _v735 = _v734.translation
        _x = _v735
        start = end
        end += 24
        (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
        _v736 = _v734.rotation
        _x = _v736
        start = end
        end += 32
        (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
      ...
      for i in range(0, length):
        ...
        if python3:
          _v743.key = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v743.key = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        if python3:
          _v743.db = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v743.db = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.primitives = []
      ...
      for i in range(0, length):
        ...
        (_v759.seq,) = _get_struct_I().unpack(str[start:end])
        _v760 = _v759.stamp
        _x = _v760
        start = end
        end += 8
        ...
        if python3:
          _v759.frame_id = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v759.frame_id = str[start:end]
        _v761 = _v758.pose
        _v762 = _v761.position
        _x = _v762
        start = end
        end += 24
        (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
        _v763 = _v761.orientation
        _x = _v763
        start = end
        end += 32
        (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
        ...
        if python3:
          _v758.id = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v758.id = str[start:end]
        _v764 = _v758.type
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        if python3:
          _v764.key = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v764.key = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        if python3:
          _v764.db = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v764.db = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v758.primitives = []
        for i in range(0, length):
          ...
          val3.dimensions = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
          _v758.primitives.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v758.primitive_poses = []
        for i in range(0, length):
          val3 = geometry_msgs.msg.Pose()
          _v765 = val3.position
          _x = _v765
          ...
          (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
          _v766 = val3.orientation
          _x = _v766
          start = end
          end += 32
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v758.primitive_poses.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v758.meshes = []
        ...
        for i in range(0, length):
          ...
          (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
          _v768 = val3.orientation
          _x = _v768
          start = end
          end += 32
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v758.mesh_poses.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v758.planes = []
        ...
        for i in range(0, length):
          ...
          (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
          _v770 = val3.orientation
          _x = _v770
          start = end
          end += 32
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v758.plane_poses.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v758.subframe_names = []
        for i in range(0, length):
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          ...
          if python3:
            ...
            val3 = str[start:end]
          _v758.subframe_names.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v758.subframe_poses = []
        for i in range(0, length):
          val3 = geometry_msgs.msg.Pose()
          _v771 = val3.position
          _x = _v771
          ...
          (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
          _v772 = val3.orientation
          _x = _v772
          start = end
          end += 32
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v758.subframe_poses.append(val3)
        start = end
        end += 1
        (_v758.operation,) = _get_struct_b().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
        for i in range(0, length):
          ...
          if python3:
            ...
            val2 = str[start:end]
          val1.touch_links.append(val2)
        _v773 = val1.detach_posture
        _v774 = _v773.header
        start = end
        end += 4
        (_v774.seq,) = _get_struct_I().unpack(str[start:end])
        _v775 = _v774.stamp
        _x = _v775
        start = end
        end += 8
        ...
        if python3:
          _v774.frame_id = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v774.frame_id = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v773.joint_names = []
        ...
        for i in range(0, length):
          ...
          val3.effort = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
          _v776 = val3.time_from_start
          _x = _v776
          start = end
          end += 8
          (_x.secs, _x.nsecs,) = _get_struct_2i().unpack(str[start:end])
          _v773.points.append(val3)
        start = end
        end += 8
        (val1.weight,) = _get_struct_d().unpack(str[start:end])
        self.action_result.result.trajectory_start.attached_collision_objects.append(val1)
