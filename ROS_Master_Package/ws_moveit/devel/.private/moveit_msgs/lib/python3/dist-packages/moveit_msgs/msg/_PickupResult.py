...
class PickupResult(genpy.Message):
  _md5sum = "10e27212825b55941c921761d6a21e16"
...
Vector3 vector
"""
  __slots__ = ['error_code','trajectory_start','trajectory_stages','trajectory_descriptions','grasp','planning_time']
  _slot_types = ['moveit_msgs/MoveItErrorCodes','moveit_msgs/RobotState','moveit_msgs/RobotTrajectory[]','string[]','moveit_msgs/Grasp','float64']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       error_code,trajectory_start,trajectory_stages,trajectory_descriptions,grasp,planning_time
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        _v71 = val1.multi_dof_joint_trajectory
        _v72 = _v71.header
        start = end
        end += 4
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        _v153 = val1.multi_dof_joint_trajectory
        _v154 = _v153.header
        start = end
        end += 4
