...
class DisplayRobotState(genpy.Message):
  _md5sum = "61c4e677a6fbbc83f0d5d9df2be85e3c"
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v33.id = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v33.id = str[start:end]
        _v39 = _v33.type
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        for i in range(0, length):
          ...
          _v33.primitives.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v33.primitive_poses = []
        for i in range(0, length):
          ...
          (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
          _v41 = val3.orientation
          _x = _v41
          start = end
          end += 32
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v33.primitive_poses.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v33.meshes = []
        ...
        for i in range(0, length):
          ...
          if python3:
            ...
            val3 = str[start:end]
          _v33.subframe_names.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v33.subframe_poses = []
        for i in range(0, length):
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v33.subframe_poses.append(val3)
        start = end
        end += 1
        (_v33.operation,) = _get_struct_b().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
      ...
      (self.hide,) = _get_struct_B().unpack(str[start:end])
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v85.id = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v85.id = str[start:end]
        _v91 = _v85.type
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        if python3:
          _v91.key = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v91.key = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        if python3:
          _v91.db = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v91.db = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v85.primitives = []
        for i in range(0, length):
          ...
          _v85.primitives.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v85.primitive_poses = []
        for i in range(0, length):
          val3 = geometry_msgs.msg.Pose()
          _v92 = val3.position
          _x = _v92
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v85.primitive_poses.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v85.meshes = []
        ...
        for i in range(0, length):
          ...
          if python3:
            ...
            val3 = str[start:end]
          _v85.subframe_names.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v85.subframe_poses = []
        for i in range(0, length):
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v85.subframe_poses.append(val3)
        start = end
        end += 1
        (_v85.operation,) = _get_struct_b().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
