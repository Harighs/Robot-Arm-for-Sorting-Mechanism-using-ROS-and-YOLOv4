// Generated by gencpp from file moveit_msgs/GetMotionSequenceRequest.msg
// DO NOT EDIT!


#ifndef MOVEIT_MSGS_MESSAGE_GETMOTIONSEQUENCEREQUEST_H
#define MOVEIT_MSGS_MESSAGE_GETMOTIONSEQUENCEREQUEST_H
...
struct GetMotionSequenceRequest_
{
  typedef GetMotionSequenceRequest_<ContainerAllocator> Type;

  GetMotionSequenceRequest_()
    : request()  {
    }
  GetMotionSequenceRequest_(const ContainerAllocator& _alloc)
    : request(_alloc)  {
  (void)_alloc;
    }
   ...
   typedef  ::moveit_msgs::MotionSequenceRequest_<ContainerAllocator>  _request_type;
  ...
  typedef boost::shared_ptr< ::moveit_msgs::GetMotionSequenceRequest_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::moveit_msgs::GetMotionSequenceRequest_<ContainerAllocator> const> ConstPtr;

}; // struct GetMotionSequenceRequest_

typedef ::moveit_msgs::GetMotionSequenceRequest_<std::allocator<void> > GetMotionSequenceRequest;

typedef boost::shared_ptr< ::moveit_msgs::GetMotionSequenceRequest > GetMotionSequenceRequestPtr;
typedef boost::shared_ptr< ::moveit_msgs::GetMotionSequenceRequest const> GetMotionSequenceRequestConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::moveit_msgs::GetMotionSequenceRequest_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::moveit_msgs::GetMotionSequenceRequest_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::moveit_msgs::GetMotionSequenceRequest_<ContainerAllocator1> & lhs, const ::moveit_msgs::GetMotionSequenceRequest_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::moveit_msgs::GetMotionSequenceRequest_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::moveit_msgs::GetMotionSequenceRequest_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::moveit_msgs::GetMotionSequenceRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::moveit_msgs::GetMotionSequenceRequest_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::moveit_msgs::GetMotionSequenceRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::moveit_msgs::GetMotionSequenceRequest_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::moveit_msgs::GetMotionSequenceRequest_<ContainerAllocator> >
{
  ...
  static const char* value(const ::moveit_msgs::GetMotionSequenceRequest_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x11150cd5e0f28e81ULL;
  static const uint64_t static_value2 = 0x50c69bc9644753dbULL;
};

template<class ContainerAllocator>
struct DataType< ::moveit_msgs::GetMotionSequenceRequest_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::moveit_msgs::GetMotionSequenceRequest_<ContainerAllocator> >
{
  static const char* value()
  {
    return "# Planning request with a list of motion commands\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::moveit_msgs::GetMotionSequenceRequest_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::moveit_msgs::GetMotionSequenceRequest_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::moveit_msgs::GetMotionSequenceRequest_<ContainerAllocator>& v)
  {
    s << indent << "request: ";
    s << std::endl;
...
#endif // MOVEIT_MSGS_MESSAGE_GETMOTIONSEQUENCEREQUEST_H
