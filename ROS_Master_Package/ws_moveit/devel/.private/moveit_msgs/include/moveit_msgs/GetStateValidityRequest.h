...
bool operator==(const ::moveit_msgs::GetStateValidityRequest_<ContainerAllocator1> & lhs, const ::moveit_msgs::GetStateValidityRequest_<ContainerAllocator2> & rhs)
{
...
struct MD5Sum< ::moveit_msgs::GetStateValidityRequest_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0xa82b6cce5fd6d630ULL;
  static const uint64_t static_value2 = 0x51640aef60a848b1ULL;
};
