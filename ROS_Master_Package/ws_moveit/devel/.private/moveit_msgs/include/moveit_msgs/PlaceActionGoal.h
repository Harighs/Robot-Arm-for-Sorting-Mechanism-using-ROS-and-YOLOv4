...
bool operator==(const ::moveit_msgs::PlaceActionGoal_<ContainerAllocator1> & lhs, const ::moveit_msgs::PlaceActionGoal_<ContainerAllocator2> & rhs)
{
...
struct MD5Sum< ::moveit_msgs::PlaceActionGoal_<ContainerAllocator> >
{
  ...
  {
    return "3f3419319ea8d2af4e18a600962d0cf5";
  }

  static const char* value(const ::moveit_msgs::PlaceActionGoal_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x3f3419319ea8d2afULL;
  static const uint64_t static_value2 = 0x4e18a600962d0cf5ULL;
};
