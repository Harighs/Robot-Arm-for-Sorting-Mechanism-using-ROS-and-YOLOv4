// Generated by gencpp from file moveit_msgs/MoveGroupSequenceActionGoal.msg
// DO NOT EDIT!


#ifndef MOVEIT_MSGS_MESSAGE_MOVEGROUPSEQUENCEACTIONGOAL_H
#define MOVEIT_MSGS_MESSAGE_MOVEGROUPSEQUENCEACTIONGOAL_H
...
struct MoveGroupSequenceActionGoal_
{
  typedef MoveGroupSequenceActionGoal_<ContainerAllocator> Type;

  MoveGroupSequenceActionGoal_()
    : header()
    , goal_id()
    , goal()  {
    }
  MoveGroupSequenceActionGoal_(const ContainerAllocator& _alloc)
    : header(_alloc)
    , goal_id(_alloc)
    , goal(_alloc)  {
  (void)_alloc;
  ...
  _goal_id_type goal_id;
   ...
   typedef  ::moveit_msgs::MoveGroupSequenceGoal_<ContainerAllocator>  _goal_type;
  _goal_type goal;
  ...
  typedef boost::shared_ptr< ::moveit_msgs::MoveGroupSequenceActionGoal_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::moveit_msgs::MoveGroupSequenceActionGoal_<ContainerAllocator> const> ConstPtr;

}; // struct MoveGroupSequenceActionGoal_

typedef ::moveit_msgs::MoveGroupSequenceActionGoal_<std::allocator<void> > MoveGroupSequenceActionGoal;

typedef boost::shared_ptr< ::moveit_msgs::MoveGroupSequenceActionGoal > MoveGroupSequenceActionGoalPtr;
typedef boost::shared_ptr< ::moveit_msgs::MoveGroupSequenceActionGoal const> MoveGroupSequenceActionGoalConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::moveit_msgs::MoveGroupSequenceActionGoal_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::moveit_msgs::MoveGroupSequenceActionGoal_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::moveit_msgs::MoveGroupSequenceActionGoal_<ContainerAllocator1> & lhs, const ::moveit_msgs::MoveGroupSequenceActionGoal_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::moveit_msgs::MoveGroupSequenceActionGoal_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::moveit_msgs::MoveGroupSequenceActionGoal_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::moveit_msgs::MoveGroupSequenceActionGoal_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::moveit_msgs::MoveGroupSequenceActionGoal_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::moveit_msgs::MoveGroupSequenceActionGoal_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::moveit_msgs::MoveGroupSequenceActionGoal_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::moveit_msgs::MoveGroupSequenceActionGoal_<ContainerAllocator> >
{
  static const char* value()
  {
    return "e8092a3ff0d4ffe7720dd24304ae29d9";
  }

  static const char* value(const ::moveit_msgs::MoveGroupSequenceActionGoal_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xe8092a3ff0d4ffe7ULL;
  static const uint64_t static_value2 = 0x720dd24304ae29d9ULL;
};

template<class ContainerAllocator>
struct DataType< ::moveit_msgs::MoveGroupSequenceActionGoal_<ContainerAllocator> >
{
  static const char* value()
  {
    return "moveit_msgs/MoveGroupSequenceActionGoal";
  }
...
template<class ContainerAllocator>
struct Definition< ::moveit_msgs::MoveGroupSequenceActionGoal_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::moveit_msgs::MoveGroupSequenceActionGoal_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::moveit_msgs::MoveGroupSequenceActionGoal_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::moveit_msgs::MoveGroupSequenceActionGoal_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
    ...
    s << indent << "goal: ";
    s << std::endl;
    Printer< ::moveit_msgs::MoveGroupSequenceGoal_<ContainerAllocator> >::stream(s, indent + "  ", v.goal);
  }
};
...
#endif // MOVEIT_MSGS_MESSAGE_MOVEGROUPSEQUENCEACTIONGOAL_H
