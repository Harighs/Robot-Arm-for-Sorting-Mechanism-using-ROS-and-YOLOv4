...
bool operator==(const ::moveit_msgs::GetCartesianPathRequest_<ContainerAllocator1> & lhs, const ::moveit_msgs::GetCartesianPathRequest_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    ...
    lhs.jump_threshold == rhs.jump_threshold &&
    lhs.prismatic_jump_threshold == rhs.prismatic_jump_threshold &&
    lhs.revolute_jump_threshold == rhs.revolute_jump_threshold &&
...
struct MD5Sum< ::moveit_msgs::GetCartesianPathRequest_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x8174baea665a893eULL;
  static const uint64_t static_value2 = 0x7f11a8af5022ababULL;
};
...
struct Definition< ::moveit_msgs::GetCartesianPathRequest_<ContainerAllocator> >
{
  static const char* value()
  {
    return "# Define the frame for the specified waypoints\n"
"Header header\n"
"\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::moveit_msgs::GetCartesianPathRequest_<ContainerAllocator> >
  {
    template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
    {
      ...
      stream.next(m.prismatic_jump_threshold);
      stream.next(m.revolute_jump_threshold);
