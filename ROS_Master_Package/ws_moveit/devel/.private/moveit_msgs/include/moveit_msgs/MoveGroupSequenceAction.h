// Generated by gencpp from file moveit_msgs/MoveGroupSequenceAction.msg
// DO NOT EDIT!


#ifndef MOVEIT_MSGS_MESSAGE_MOVEGROUPSEQUENCEACTION_H
#define MOVEIT_MSGS_MESSAGE_MOVEGROUPSEQUENCEACTION_H
...
struct MoveGroupSequenceAction_
{
  typedef MoveGroupSequenceAction_<ContainerAllocator> Type;

  MoveGroupSequenceAction_()
    : action_goal()
    , action_result()
    , action_feedback()  {
    }
  MoveGroupSequenceAction_(const ContainerAllocator& _alloc)
    : action_goal(_alloc)
  ...
  (void)_alloc;
   ...
   typedef  ::moveit_msgs::MoveGroupSequenceActionGoal_<ContainerAllocator>  _action_goal_type;
  _action_goal_type action_goal;

   typedef  ::moveit_msgs::MoveGroupSequenceActionResult_<ContainerAllocator>  _action_result_type;
  _action_result_type action_result;

   typedef  ::moveit_msgs::MoveGroupSequenceActionFeedback_<ContainerAllocator>  _action_feedback_type;
  ...
  typedef boost::shared_ptr< ::moveit_msgs::MoveGroupSequenceAction_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::moveit_msgs::MoveGroupSequenceAction_<ContainerAllocator> const> ConstPtr;

}; // struct MoveGroupSequenceAction_

typedef ::moveit_msgs::MoveGroupSequenceAction_<std::allocator<void> > MoveGroupSequenceAction;

typedef boost::shared_ptr< ::moveit_msgs::MoveGroupSequenceAction > MoveGroupSequenceActionPtr;
typedef boost::shared_ptr< ::moveit_msgs::MoveGroupSequenceAction const> MoveGroupSequenceActionConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::moveit_msgs::MoveGroupSequenceAction_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::moveit_msgs::MoveGroupSequenceAction_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::moveit_msgs::MoveGroupSequenceAction_<ContainerAllocator1> & lhs, const ::moveit_msgs::MoveGroupSequenceAction_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::moveit_msgs::MoveGroupSequenceAction_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::moveit_msgs::MoveGroupSequenceAction_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::moveit_msgs::MoveGroupSequenceAction_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::moveit_msgs::MoveGroupSequenceAction_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::moveit_msgs::MoveGroupSequenceAction_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::moveit_msgs::MoveGroupSequenceAction_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::moveit_msgs::MoveGroupSequenceAction_<ContainerAllocator> >
{
  static const char* value()
  {
    return "475daac0686b85f9091fb82c70a9932c";
  }

  static const char* value(const ::moveit_msgs::MoveGroupSequenceAction_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x475daac0686b85f9ULL;
  static const uint64_t static_value2 = 0x091fb82c70a9932cULL;
};

template<class ContainerAllocator>
struct DataType< ::moveit_msgs::MoveGroupSequenceAction_<ContainerAllocator> >
{
  static const char* value()
  {
    return "moveit_msgs/MoveGroupSequenceAction";
  }
...
template<class ContainerAllocator>
struct Definition< ::moveit_msgs::MoveGroupSequenceAction_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::moveit_msgs::MoveGroupSequenceAction_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::moveit_msgs::MoveGroupSequenceAction_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::moveit_msgs::MoveGroupSequenceAction_<ContainerAllocator>& v)
  {
    s << indent << "action_goal: ";
    s << std::endl;
    Printer< ::moveit_msgs::MoveGroupSequenceActionGoal_<ContainerAllocator> >::stream(s, indent + "  ", v.action_goal);
    s << indent << "action_result: ";
    s << std::endl;
    Printer< ::moveit_msgs::MoveGroupSequenceActionResult_<ContainerAllocator> >::stream(s, indent + "  ", v.action_result);
    s << indent << "action_feedback: ";
    s << std::endl;
    Printer< ::moveit_msgs::MoveGroupSequenceActionFeedback_<ContainerAllocator> >::stream(s, indent + "  ", v.action_feedback);
  }
};
...
#endif // MOVEIT_MSGS_MESSAGE_MOVEGROUPSEQUENCEACTION_H
