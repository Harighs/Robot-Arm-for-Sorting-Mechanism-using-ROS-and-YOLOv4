...
bool operator==(const ::moveit_msgs::MoveGroupAction_<ContainerAllocator1> & lhs, const ::moveit_msgs::MoveGroupAction_<ContainerAllocator2> & rhs)
{
...
struct MD5Sum< ::moveit_msgs::MoveGroupAction_<ContainerAllocator> >
{
  ...
  {
    return "6337a63f836aa32e02cee901b8c83a22";
  }

  static const char* value(const ::moveit_msgs::MoveGroupAction_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x6337a63f836aa32eULL;
  static const uint64_t static_value2 = 0x02cee901b8c83a22ULL;
};
