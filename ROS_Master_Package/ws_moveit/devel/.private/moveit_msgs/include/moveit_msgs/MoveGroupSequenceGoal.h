// Generated by gencpp from file moveit_msgs/MoveGroupSequenceGoal.msg
// DO NOT EDIT!


#ifndef MOVEIT_MSGS_MESSAGE_MOVEGROUPSEQUENCEGOAL_H
#define MOVEIT_MSGS_MESSAGE_MOVEGROUPSEQUENCEGOAL_H
...
struct MoveGroupSequenceGoal_
{
  typedef MoveGroupSequenceGoal_<ContainerAllocator> Type;

  MoveGroupSequenceGoal_()
    : request()
    , planning_options()  {
    }
  MoveGroupSequenceGoal_(const ContainerAllocator& _alloc)
    : request(_alloc)
  ...
  typedef boost::shared_ptr< ::moveit_msgs::MoveGroupSequenceGoal_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::moveit_msgs::MoveGroupSequenceGoal_<ContainerAllocator> const> ConstPtr;

}; // struct MoveGroupSequenceGoal_

typedef ::moveit_msgs::MoveGroupSequenceGoal_<std::allocator<void> > MoveGroupSequenceGoal;

typedef boost::shared_ptr< ::moveit_msgs::MoveGroupSequenceGoal > MoveGroupSequenceGoalPtr;
typedef boost::shared_ptr< ::moveit_msgs::MoveGroupSequenceGoal const> MoveGroupSequenceGoalConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::moveit_msgs::MoveGroupSequenceGoal_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::moveit_msgs::MoveGroupSequenceGoal_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::moveit_msgs::MoveGroupSequenceGoal_<ContainerAllocator1> & lhs, const ::moveit_msgs::MoveGroupSequenceGoal_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::moveit_msgs::MoveGroupSequenceGoal_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::moveit_msgs::MoveGroupSequenceGoal_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::moveit_msgs::MoveGroupSequenceGoal_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::moveit_msgs::MoveGroupSequenceGoal_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::moveit_msgs::MoveGroupSequenceGoal_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::moveit_msgs::MoveGroupSequenceGoal_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::moveit_msgs::MoveGroupSequenceGoal_<ContainerAllocator> >
{
  static const char* value()
  {
    return "ffb5d660ea6e0aa4569898d2d0b1d51f";
  }

  static const char* value(const ::moveit_msgs::MoveGroupSequenceGoal_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xffb5d660ea6e0aa4ULL;
  static const uint64_t static_value2 = 0x569898d2d0b1d51fULL;
};

template<class ContainerAllocator>
struct DataType< ::moveit_msgs::MoveGroupSequenceGoal_<ContainerAllocator> >
{
  static const char* value()
  {
    return "moveit_msgs/MoveGroupSequenceGoal";
  }
...
template<class ContainerAllocator>
struct Definition< ::moveit_msgs::MoveGroupSequenceGoal_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::moveit_msgs::MoveGroupSequenceGoal_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::moveit_msgs::MoveGroupSequenceGoal_<ContainerAllocator> >
{
...
#endif // MOVEIT_MSGS_MESSAGE_MOVEGROUPSEQUENCEGOAL_H
