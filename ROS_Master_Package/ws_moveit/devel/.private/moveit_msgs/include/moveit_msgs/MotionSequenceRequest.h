// Generated by gencpp from file moveit_msgs/MotionSequenceRequest.msg
// DO NOT EDIT!


#ifndef MOVEIT_MSGS_MESSAGE_MOTIONSEQUENCEREQUEST_H
#define MOVEIT_MSGS_MESSAGE_MOTIONSEQUENCEREQUEST_H
...
{
  typedef MotionSequenceRequest_<ContainerAllocator> Type;

  MotionSequenceRequest_()
    : items()  {
    }
  MotionSequenceRequest_(const ContainerAllocator& _alloc)
    : items(_alloc)  {
  (void)_alloc;
    }
   ...
   typedef std::vector< ::moveit_msgs::MotionSequenceItem_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::moveit_msgs::MotionSequenceItem_<ContainerAllocator> >::other >  _items_type;
  _items_type items;
  ...
  typedef boost::shared_ptr< ::moveit_msgs::MotionSequenceRequest_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::moveit_msgs::MotionSequenceRequest_<ContainerAllocator> const> ConstPtr;

}; // struct MotionSequenceRequest_

typedef ::moveit_msgs::MotionSequenceRequest_<std::allocator<void> > MotionSequenceRequest;

typedef boost::shared_ptr< ::moveit_msgs::MotionSequenceRequest > MotionSequenceRequestPtr;
typedef boost::shared_ptr< ::moveit_msgs::MotionSequenceRequest const> MotionSequenceRequestConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::moveit_msgs::MotionSequenceRequest_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::moveit_msgs::MotionSequenceRequest_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::moveit_msgs::MotionSequenceRequest_<ContainerAllocator1> & lhs, const ::moveit_msgs::MotionSequenceRequest_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::moveit_msgs::MotionSequenceRequest_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::moveit_msgs::MotionSequenceRequest_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::moveit_msgs::MotionSequenceRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::moveit_msgs::MotionSequenceRequest_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::moveit_msgs::MotionSequenceRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::moveit_msgs::MotionSequenceRequest_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::moveit_msgs::MotionSequenceRequest_<ContainerAllocator> >
{
  ...
  static const char* value(const ::moveit_msgs::MotionSequenceRequest_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xd6e6d4da3bede363ULL;
  static const uint64_t static_value2 = 0xf50e4ffbac7629a0ULL;
};

template<class ContainerAllocator>
struct DataType< ::moveit_msgs::MotionSequenceRequest_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::moveit_msgs::MotionSequenceRequest_<ContainerAllocator> >
{
  static const char* value()
  {
    return "# List of motion planning request with a blend_radius for each.\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::moveit_msgs::MotionSequenceRequest_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::moveit_msgs::MotionSequenceRequest_<ContainerAllocator> >
{
...
#endif // MOVEIT_MSGS_MESSAGE_MOTIONSEQUENCEREQUEST_H
