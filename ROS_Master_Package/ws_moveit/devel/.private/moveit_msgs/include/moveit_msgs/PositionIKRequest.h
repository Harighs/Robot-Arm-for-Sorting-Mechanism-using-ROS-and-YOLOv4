...
bool operator==(const ::moveit_msgs::PositionIKRequest_<ContainerAllocator1> & lhs, const ::moveit_msgs::PositionIKRequest_<ContainerAllocator2> & rhs)
{
...
struct MD5Sum< ::moveit_msgs::PositionIKRequest_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0xcb7c3615ee4d29d0ULL;
  static const uint64_t static_value2 = 0x23dfdc5950af0504ULL;
};
