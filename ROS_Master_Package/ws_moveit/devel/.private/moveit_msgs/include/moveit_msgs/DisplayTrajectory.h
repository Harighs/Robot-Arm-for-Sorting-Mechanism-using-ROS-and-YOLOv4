...
bool operator==(const ::moveit_msgs::DisplayTrajectory_<ContainerAllocator1> & lhs, const ::moveit_msgs::DisplayTrajectory_<ContainerAllocator2> & rhs)
{
...
struct MD5Sum< ::moveit_msgs::DisplayTrajectory_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x41936b74e168ba75ULL;
  static const uint64_t static_value2 = 0x4279ae683ce3f121ULL;
};
