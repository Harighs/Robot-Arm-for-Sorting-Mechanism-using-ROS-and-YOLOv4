// Generated by gencpp from file moveit_msgs/MotionSequenceItem.msg
// DO NOT EDIT!


#ifndef MOVEIT_MSGS_MESSAGE_MOTIONSEQUENCEITEM_H
#define MOVEIT_MSGS_MESSAGE_MOTIONSEQUENCEITEM_H
...
{
  typedef MotionSequenceItem_<ContainerAllocator> Type;

  MotionSequenceItem_()
    : req()
    , blend_radius(0.0)  {
    }
  MotionSequenceItem_(const ContainerAllocator& _alloc)
    : req(_alloc)
    , blend_radius(0.0)  {
  (void)_alloc;
    }
   ...
   typedef  ::moveit_msgs::MotionPlanRequest_<ContainerAllocator>  _req_type;
  _req_type req;
  ...
  typedef boost::shared_ptr< ::moveit_msgs::MotionSequenceItem_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::moveit_msgs::MotionSequenceItem_<ContainerAllocator> const> ConstPtr;

}; // struct MotionSequenceItem_

typedef ::moveit_msgs::MotionSequenceItem_<std::allocator<void> > MotionSequenceItem;

typedef boost::shared_ptr< ::moveit_msgs::MotionSequenceItem > MotionSequenceItemPtr;
typedef boost::shared_ptr< ::moveit_msgs::MotionSequenceItem const> MotionSequenceItemConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::moveit_msgs::MotionSequenceItem_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::moveit_msgs::MotionSequenceItem_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::moveit_msgs::MotionSequenceItem_<ContainerAllocator1> & lhs, const ::moveit_msgs::MotionSequenceItem_<ContainerAllocator2> & rhs)
{
  return lhs.req == rhs.req &&
    lhs.blend_radius == rhs.blend_radius;
}
...
template <class ContainerAllocator>
struct IsMessage< ::moveit_msgs::MotionSequenceItem_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::moveit_msgs::MotionSequenceItem_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::moveit_msgs::MotionSequenceItem_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::moveit_msgs::MotionSequenceItem_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::moveit_msgs::MotionSequenceItem_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::moveit_msgs::MotionSequenceItem_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::moveit_msgs::MotionSequenceItem_<ContainerAllocator> >
{
  ...
  static const char* value(const ::moveit_msgs::MotionSequenceItem_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x2d640cc6ec9b15fdULL;
  static const uint64_t static_value2 = 0xbde900aedc333486ULL;
};

template<class ContainerAllocator>
struct DataType< ::moveit_msgs::MotionSequenceItem_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::moveit_msgs::MotionSequenceItem_<ContainerAllocator> >
{
  static const char* value()
  {
    return "# The plan request for this item.\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::moveit_msgs::MotionSequenceItem_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::moveit_msgs::MotionSequenceItem_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::moveit_msgs::MotionSequenceItem_<ContainerAllocator>& v)
  {
    s << indent << "req: ";
    s << std::endl;
    Printer< ::moveit_msgs::MotionPlanRequest_<ContainerAllocator> >::stream(s, indent + "  ", v.req);
    s << indent << "blend_radius: ";
    Printer<double>::stream(s, indent + "  ", v.blend_radius);
  }
};
...
#endif // MOVEIT_MSGS_MESSAGE_MOTIONSEQUENCEITEM_H
