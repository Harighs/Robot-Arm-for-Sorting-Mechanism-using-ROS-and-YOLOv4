...
bool operator==(const ::moveit_msgs::DeleteRobotStateFromWarehouseRequest_<ContainerAllocator1> & lhs, const ::moveit_msgs::DeleteRobotStateFromWarehouseRequest_<ContainerAllocator2> & rhs)
{
