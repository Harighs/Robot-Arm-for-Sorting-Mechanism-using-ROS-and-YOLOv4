...
bool operator==(const ::moveit_msgs::GetPositionIKRequest_<ContainerAllocator1> & lhs, const ::moveit_msgs::GetPositionIKRequest_<ContainerAllocator2> & rhs)
{
...
struct MD5Sum< ::moveit_msgs::GetPositionIKRequest_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x8388b54598336654ULL;
  static const uint64_t static_value2 = 0xbca82763f918a740ULL;
};
