...
bool operator==(const ::moveit_msgs::SaveRobotStateToWarehouseRequest_<ContainerAllocator1> & lhs, const ::moveit_msgs::SaveRobotStateToWarehouseRequest_<ContainerAllocator2> & rhs)
{
...
struct MD5Sum< ::moveit_msgs::SaveRobotStateToWarehouseRequest_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x0d6079a7122f4762ULL;
  static const uint64_t static_value2 = 0x6b926754a46037d9ULL;
};
