...
bool operator==(const ::moveit_msgs::PickupGoal_<ContainerAllocator1> & lhs, const ::moveit_msgs::PickupGoal_<ContainerAllocator2> & rhs)
{
  return lhs.target_name == rhs.target_name &&
    ...
    lhs.minimize_object_distance == rhs.minimize_object_distance &&
...
struct MD5Sum< ::moveit_msgs::PickupGoal_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x3a71f6f9bc6e6405ULL;
  static const uint64_t static_value2 = 0x94ce6a411ccfe764ULL;
};
