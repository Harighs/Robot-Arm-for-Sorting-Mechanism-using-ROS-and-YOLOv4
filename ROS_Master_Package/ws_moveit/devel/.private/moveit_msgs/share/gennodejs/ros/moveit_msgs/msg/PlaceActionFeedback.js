...
class PlaceActionFeedback {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = PlaceFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new PlaceActionFeedback(null);
    ...
    data.feedback = PlaceFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += PlaceFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PlaceActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = PlaceFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new PlaceFeedback()
    }
...
module.exports = PlaceActionFeedback;
