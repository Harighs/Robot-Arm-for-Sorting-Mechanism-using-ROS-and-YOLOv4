...
class MoveGroupActionFeedback {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = MoveGroupFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new MoveGroupActionFeedback(null);
    ...
    data.feedback = MoveGroupFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += MoveGroupFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MoveGroupActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = MoveGroupFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new MoveGroupFeedback()
    }
...
module.exports = MoveGroupActionFeedback;
