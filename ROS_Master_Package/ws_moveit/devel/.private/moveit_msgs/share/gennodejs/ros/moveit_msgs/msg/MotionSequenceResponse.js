...
class MotionSequenceResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('sequence_start')) {
        this.sequence_start = initObj.sequence_start
      }
      else {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type MotionSequenceResponse
    // Serialize message field [error_code]
    bufferOffset = MoveItErrorCodes.serialize(obj.error_code, buffer, bufferOffset);
    // Serialize message field [sequence_start]
    bufferOffset = RobotState.serialize(obj.sequence_start, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type MotionSequenceResponse
    let len;
    let data = new MotionSequenceResponse(null);
    // Deserialize message field [error_code]
    data.error_code = MoveItErrorCodes.deserialize(buffer, bufferOffset);
    // Deserialize message field [sequence_start]
    data.sequence_start = RobotState.deserialize(buffer, bufferOffset);
    ...
    for (let i = 0; i < len; ++i) {
      data.planned_trajectories[i] = RobotTrajectory.deserialize(buffer, bufferOffset)
    }
  ...
  static getMessageSize(object) {
    let length = 0;
    length += RobotState.getMessageSize(object.sequence_start);
  ...
  static md5sum() {
    ...
    return '3cfbd71b06d8199bf604ebb8d6627be1';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MotionSequenceResponse(null);
    ...
    if (msg.sequence_start !== undefined) {
      resolved.sequence_start = RobotState.Resolve(msg.sequence_start)
    }
    else {
      resolved.sequence_start = new RobotState()
    }
    ...
    if (msg.planned_trajectories !== undefined) {
      ...
      for (let i = 0; i < resolved.planned_trajectories.length; ++i) {
        resolved.planned_trajectories[i] = RobotTrajectory.Resolve(msg.planned_trajectories[i]);
      }
    }
    else {
...
module.exports = MotionSequenceResponse;
