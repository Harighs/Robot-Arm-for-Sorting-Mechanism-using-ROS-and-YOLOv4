...
class PickupActionFeedback {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = PickupFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new PickupActionFeedback(null);
    ...
    data.feedback = PickupFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += PickupFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PickupActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = PickupFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new PickupFeedback()
    }
...
module.exports = PickupActionFeedback;
