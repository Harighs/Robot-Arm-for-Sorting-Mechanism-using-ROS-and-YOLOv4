...
let MotionSequenceRequest = require('../msg/MotionSequenceRequest.js');

//-----------------------------------------------------------

let MotionSequenceResponse = require('../msg/MotionSequenceResponse.js');

//-----------------------------------------------------------

class GetMotionSequenceRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetMotionSequenceRequest
    // Serialize message field [request]
    bufferOffset = MotionSequenceRequest.serialize(obj.request, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetMotionSequenceRequest
    let len;
    let data = new GetMotionSequenceRequest(null);
    // Deserialize message field [request]
    data.request = MotionSequenceRequest.deserialize(buffer, bufferOffset);
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += MotionSequenceRequest.getMessageSize(object.request);
    return length;
  }

  static datatype() {
    // Returns string type for a service object
    return 'moveit_msgs/GetMotionSequenceRequest';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '11150cd5e0f28e8150c69bc9644753db';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetMotionSequenceRequest(null);
    if (msg.request !== undefined) {
      resolved.request = MotionSequenceRequest.Resolve(msg.request)
    }
    else {
      resolved.request = new MotionSequenceRequest()
    }
...
class GetMotionSequenceResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.response = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetMotionSequenceResponse
    // Serialize message field [response]
    bufferOffset = MotionSequenceResponse.serialize(obj.response, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetMotionSequenceResponse
    let len;
    let data = new GetMotionSequenceResponse(null);
    // Deserialize message field [response]
    data.response = MotionSequenceResponse.deserialize(buffer, bufferOffset);
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += MotionSequenceResponse.getMessageSize(object.response);
    return length;
  }

  static datatype() {
    // Returns string type for a service object
    return 'moveit_msgs/GetMotionSequenceResponse';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return 'f9e8d60e1364fc328ca518c74adb130b';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetMotionSequenceResponse(null);
    if (msg.response !== undefined) {
      resolved.response = MotionSequenceResponse.Resolve(msg.response)
    }
    else {
      resolved.response = new MotionSequenceResponse()
    }
...
module.exports = {
  Request: GetMotionSequenceRequest,
  Response: GetMotionSequenceResponse,
  md5sum() { return 'f94589b40ccfbb6b16dda7fd233b2a28'; },
  datatype() { return 'moveit_msgs/GetMotionSequence'; }
};
