...
class TrajectoryConstraints {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type TrajectoryConstraints
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type TrajectoryConstraints
    let len;
    let data = new TrajectoryConstraints(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.constraints[i] = Constraints.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TrajectoryConstraints(null);
    if (msg.constraints !== undefined) {
      ...
      for (let i = 0; i < resolved.constraints.length; ++i) {
        resolved.constraints[i] = Constraints.Resolve(msg.constraints[i]);
      }
    }
    else {
...
module.exports = TrajectoryConstraints;
