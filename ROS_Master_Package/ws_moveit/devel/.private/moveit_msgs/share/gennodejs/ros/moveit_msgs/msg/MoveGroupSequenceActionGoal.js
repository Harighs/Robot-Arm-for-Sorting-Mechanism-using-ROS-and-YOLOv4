...
class MoveGroupSequenceActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type MoveGroupSequenceActionGoal
    // Serialize message field [header]
    bufferOffset = std_msgs.msg.Header.serialize(obj.header, buffer, bufferOffset);
    // Serialize message field [goal_id]
    bufferOffset = actionlib_msgs.msg.GoalID.serialize(obj.goal_id, buffer, bufferOffset);
    // Serialize message field [goal]
    bufferOffset = MoveGroupSequenceGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type MoveGroupSequenceActionGoal
    let len;
    let data = new MoveGroupSequenceActionGoal(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [goal_id]
    data.goal_id = actionlib_msgs.msg.GoalID.deserialize(buffer, bufferOffset);
    // Deserialize message field [goal]
    data.goal = MoveGroupSequenceGoal.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += MoveGroupSequenceGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MoveGroupSequenceActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = MoveGroupSequenceGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new MoveGroupSequenceGoal()
    }
...
module.exports = MoveGroupSequenceActionGoal;
