...
class MoveGroupSequenceAction {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type MoveGroupSequenceAction
    // Serialize message field [action_goal]
    bufferOffset = MoveGroupSequenceActionGoal.serialize(obj.action_goal, buffer, bufferOffset);
    // Serialize message field [action_result]
    bufferOffset = MoveGroupSequenceActionResult.serialize(obj.action_result, buffer, bufferOffset);
    // Serialize message field [action_feedback]
    bufferOffset = MoveGroupSequenceActionFeedback.serialize(obj.action_feedback, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type MoveGroupSequenceAction
    let len;
    let data = new MoveGroupSequenceAction(null);
    // Deserialize message field [action_goal]
    data.action_goal = MoveGroupSequenceActionGoal.deserialize(buffer, bufferOffset);
    // Deserialize message field [action_result]
    data.action_result = MoveGroupSequenceActionResult.deserialize(buffer, bufferOffset);
    // Deserialize message field [action_feedback]
    data.action_feedback = MoveGroupSequenceActionFeedback.deserialize(buffer, bufferOffset);
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += MoveGroupSequenceActionGoal.getMessageSize(object.action_goal);
    length += MoveGroupSequenceActionResult.getMessageSize(object.action_result);
    length += MoveGroupSequenceActionFeedback.getMessageSize(object.action_feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MoveGroupSequenceAction(null);
    if (msg.action_goal !== undefined) {
      resolved.action_goal = MoveGroupSequenceActionGoal.Resolve(msg.action_goal)
    }
    else {
      resolved.action_goal = new MoveGroupSequenceActionGoal()
    }

    if (msg.action_result !== undefined) {
      resolved.action_result = MoveGroupSequenceActionResult.Resolve(msg.action_result)
    }
    else {
      resolved.action_result = new MoveGroupSequenceActionResult()
    }

    if (msg.action_feedback !== undefined) {
      resolved.action_feedback = MoveGroupSequenceActionFeedback.Resolve(msg.action_feedback)
    }
    else {
      resolved.action_feedback = new MoveGroupSequenceActionFeedback()
    }
...
module.exports = MoveGroupSequenceAction;
