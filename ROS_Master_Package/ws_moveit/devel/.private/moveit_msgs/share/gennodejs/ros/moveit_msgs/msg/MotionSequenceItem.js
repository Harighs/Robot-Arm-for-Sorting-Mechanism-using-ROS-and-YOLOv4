...
class MotionSequenceItem {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('blend_radius')) {
        this.blend_radius = initObj.blend_radius
      }
      else {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type MotionSequenceItem
    // Serialize message field [req]
    bufferOffset = MotionPlanRequest.serialize(obj.req, buffer, bufferOffset);
    // Serialize message field [blend_radius]
    bufferOffset = _serializer.float64(obj.blend_radius, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type MotionSequenceItem
    let len;
    let data = new MotionSequenceItem(null);
    // Deserialize message field [req]
    data.req = MotionPlanRequest.deserialize(buffer, bufferOffset);
    // Deserialize message field [blend_radius]
    data.blend_radius = _deserializer.float64(buffer, bufferOffset);
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += MotionPlanRequest.getMessageSize(object.req);
    return length + 8;
  }

  static datatype() {
    // Returns string type for a message object
    return 'moveit_msgs/MotionSequenceItem';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '2d640cc6ec9b15fdbde900aedc333486';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MotionSequenceItem(null);
    if (msg.req !== undefined) {
      resolved.req = MotionPlanRequest.Resolve(msg.req)
    }
    else {
      resolved.req = new MotionPlanRequest()
    }

    if (msg.blend_radius !== undefined) {
      resolved.blend_radius = msg.blend_radius;
    }
    else {
      resolved.blend_radius = 0.0
    }
...
module.exports = MotionSequenceItem;
