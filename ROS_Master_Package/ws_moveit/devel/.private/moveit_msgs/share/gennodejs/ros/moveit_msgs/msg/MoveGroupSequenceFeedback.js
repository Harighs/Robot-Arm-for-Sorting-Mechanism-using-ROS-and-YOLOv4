...
class MoveGroupSequenceFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new MoveGroupSequenceFeedback(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new MoveGroupSequenceFeedback(null);
...
module.exports = MoveGroupSequenceFeedback;
